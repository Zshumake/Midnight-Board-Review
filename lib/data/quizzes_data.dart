...
final Map<String, EpisodeQuiz> quizzes = {
  ...
  'Traumatic Brain Injury 1': const EpisodeQuiz(episodeTitle: 'Traumatic Brain Injury 1', questions: [
    QuizQuestion(question: 'What is the leading cause of TBI-related emergency department visits and hospitalizations?', options: ['Motor vehicle accidents', 'Falls', 'Firearm injuries', 'Sports-related injuries'], correctIndex: 1, explanation: 'Falls account for 48% of TBI-related ED visits and 52% of hospitalizations, making them the number one cause overall.'),
    QuizQuestion(question: 'TBI has a bimodal age distribution. Which age group has the highest mortality rate?', options: ['Ages 0 to 5', 'Ages 15 to 24', 'Ages 25 to 44', 'Ages 65 and older'], correctIndex: 3, explanation: 'The elderly population aged 65 and older has the highest mortality rate due to reduced physiological reserve, comorbidities, anticoagulant use, and brain atrophy.'),
    QuizQuestion(question: 'What is the approximate male-to-female ratio for TBI incidence?', options: ['1 to 1', '1.5 to 1', '2.5 to 1', '5 to 1'], correctIndex: 2, explanation: 'The male-to-female ratio for TBI is roughly 2.5 to 1, with males accounting for about 74% of TBIs according to model system data.'),
    QuizQuestion(question: 'According to CDC data, approximately how many Americans are currently living with TBI-related disabilities?', options: ['1.2 million', '2.8 million', '5.3 million', '8.1 million'], correctIndex: 2, explanation: 'Approximately 5.3 million Americans are currently living with TBI-related disabilities, representing a large chronic disease population.'),
    QuizQuestion(question: 'What is the single most common cause of death or severe injury in a motor vehicle accident?', options: ['Head-on collision', 'T-bone impact at an intersection', 'Ejection from the vehicle', 'Rollover without ejection'], correctIndex: 2, explanation: 'Ejection from the vehicle is the single most common cause of death or severe injury in an MVA because the forces involved are exponential.'),
  ]),

  'Traumatic Brain Injury 2': const EpisodeQuiz(episodeTitle: 'Traumatic Brain Injury 2', questions: [
    QuizQuestion(question: 'A patient in a vegetative state after a traumatic brain injury has been in that state for 6 months. Can this be classified as permanent?', options: ['Yes, any vegetative state beyond 3 months is permanent', 'Yes, 6 months exceeds the threshold for traumatic injuries', 'No, permanent vegetative state after TBI requires 12 months', 'No, permanent vegetative state cannot be declared for traumatic injuries'], correctIndex: 2, explanation: 'For traumatic brain injury, a vegetative state is not considered permanent until 12 months have passed. For non-traumatic injuries such as anoxia, the threshold is 3 months.'),
    QuizQuestion(question: 'Which finding best distinguishes a minimally conscious state from a vegetative state?', options: ['Spontaneous eye opening', 'Sleep-wake cycles on EEG', 'Visual fixation and smooth pursuit tracking', 'Roving eye movements'], correctIndex: 2, explanation: 'Visual fixation and smooth pursuit tracking are major differentiators between MCS and VS. VS patients have roving eye movements but cannot lock on and follow an object.'),
    QuizQuestion(question: 'On the Glasgow Coma Scale motor subscale, what distinguishes localization (score of 5) from withdrawal (score of 4)?', options: ['Any movement of the extremities in response to pain', 'The hand crosses the midline toward the stimulus to stop it', 'Flexion posturing of the upper extremities', 'Extension posturing of all extremities'], correctIndex: 1, explanation: 'Localization requires the hand to cross the midline and move toward the stimulus in a coordinated attempt to stop it, indicating higher-level brain processing than simple withdrawal.'),
    QuizQuestion(question: 'Which pharmacologic agent has class one evidence from the NEJM for accelerating functional recovery in severe TBI disorders of consciousness?', options: ['Bromocriptine', 'Methylphenidate', 'Amantadine', 'Modafinil'], correctIndex: 2, explanation: 'Amantadine is the only agent with strong class one evidence, from a major NEJM paper by Giacino in 2012, showing it accelerated functional recovery in severe TBI.'),
    QuizQuestion(question: 'In decerebrate posturing, the lesion is located at or below which anatomical structure?', options: ['Internal capsule', 'Thalamus', 'Red nucleus', 'Cerebral cortex'], correctIndex: 2, explanation: 'Decerebrate posturing results from a lesion at or below the red nucleus in the midbrain. With the red nucleus knocked out, the vestibulospinal tract drives unopposed extension of all extremities.'),
  ]),

  'Traumatic Brain Injury 3': const EpisodeQuiz(episodeTitle: 'Traumatic Brain Injury 3', questions: [
    QuizQuestion(question: 'On the Functional Independence Measure, what is the minimum level at which no physical helper is required?', options: ['Level 5 - Supervision', 'Level 6 - Modified Independence', 'Level 7 - Complete Independence', 'Level 4 - Minimal Assist'], correctIndex: 1, explanation: 'Level 6 (Modified Independence) and Level 7 (Complete Independence) both require no helper to be physically present. Level 6 allows use of a device or extra time.'),
    QuizQuestion(question: 'On the FIM scale, a task that requires two helpers is automatically scored as which level?', options: ['Level 2 - Maximal Assist', 'Level 1 - Total Assist', 'Level 3 - Moderate Assist', 'Level 4 - Minimal Assist'], correctIndex: 1, explanation: 'If a task requires two helpers for any reason, it is automatically scored as Level 1 (Total Assist) regardless of how much effort the patient contributes.'),
    QuizQuestion(question: 'What is the ICP threshold at which treatment intervention is required?', options: ['Greater than 10 mmHg', 'Greater than 15 mmHg', 'Greater than 20 mmHg', 'Greater than 25 mmHg'], correctIndex: 2, explanation: 'The threshold for ICP intervention is greater than 20 mmHg. If ICP stays above 20 for more than five minutes, action must be taken.'),
    QuizQuestion(question: 'In the CPP equation (CPP = MAP - ICP), what is the minimum target cerebral perfusion pressure?', options: ['Greater than 40 mmHg', 'Greater than 50 mmHg', 'Greater than 60 mmHg', 'Greater than 70 mmHg'], correctIndex: 2, explanation: 'The target CPP is greater than 60 mmHg. Data shows that if CPP drops below 50, mortality increases significantly.'),
    QuizQuestion(question: 'Why is propofol preferred over benzodiazepines for sedation in the neuro ICU for TBI patients?', options: ['It is cheaper and more widely available', 'It has a shorter half-life allowing wake-up tests and it lowers ICP', 'It raises blood pressure which improves cerebral perfusion', 'It has no significant side effects in TBI patients'], correctIndex: 1, explanation: 'Propofol has a very short half-life allowing wake-up tests within minutes, and it also directly lowers ICP. Benzodiazepines have long half-lives that obscure neurological exams.'),
  ]),

  'Traumatic Brain Injury 4': const EpisodeQuiz(episodeTitle: 'Traumatic Brain Injury 4', questions: [
    QuizQuestion(question: 'Which anti-epileptic drug is associated with an ADH-like effect causing hyponatremia?', options: ['Phenytoin', 'Valproic acid', 'Carbamazepine', 'Levetiracetam'], correctIndex: 2, explanation: 'Carbamazepine has an ADH-like effect that causes the body to retain water, diluting serum sodium and leading to hyponatremia with decreased serum osmolality.'),
    QuizQuestion(question: 'A TBI patient on valproic acid becomes increasingly confused with normal liver enzymes. What lab value should be checked?', options: ['Serum sodium', 'Ammonia level', 'Phenytoin trough level', 'Serum calcium'], correctIndex: 1, explanation: 'Valproic acid can cause hyperammonemia by interfering with the urea cycle, even when liver enzymes are normal. Elevated ammonia can mimic hepatic encephalopathy.'),
    QuizQuestion(question: 'Which chronic side effect of phenytoin is particularly devastating from a rehabilitation perspective?', options: ['Gingival hyperplasia', 'Hirsutism', 'Cerebellar atrophy', 'Megaloblastic anemia'], correctIndex: 2, explanation: 'Chronic phenytoin toxicity can cause permanent cerebellar atrophy, directly undermining balance and coordination rehabilitation efforts in TBI patients.'),
    QuizQuestion(question: 'Which anti-epileptic drug is a potent enzyme inducer that can lower levels of phenytoin and valproic acid when added to a regimen?', options: ['Levetiracetam', 'Gabapentin', 'Carbamazepine', 'Phenobarbital'], correctIndex: 2, explanation: 'Carbamazepine is a potent cytochrome P450 inducer that accelerates the metabolism of other drugs, lowering levels of phenytoin, valproic acid, and haloperidol.'),
    QuizQuestion(question: 'What is the behavioral side effect profile most associated with levetiracetam (Keppra)?', options: ['Sedation and weight gain', 'Gingival hyperplasia and hirsutism', 'Irritability, depression, and suicidality', 'Paradoxical hyperactivity in children'], correctIndex: 2, explanation: 'Levetiracetam is associated with irritability, depression, and even suicidality, sometimes called Keppra rage, which can be difficult to distinguish from TBI-related behavioral changes.'),
  ]),

  'Traumatic Brain Injury 5': const EpisodeQuiz(episodeTitle: 'Traumatic Brain Injury 5', questions: [
    QuizQuestion(
      question: 'What is the first step in managing an agitated patient with TBI according to the hierarchy of intervention?',
      options: ['Administer benzodiazepines', 'Apply physical restraints', 'Assess the environment and ensure safety through environmental modifications', 'Start maintenance medications such as SSRIs'],
      correctIndex: 2,
      explanation: 'The source material emphasizes that the first step is not medication. You begin with environmental modifications such as floor beds, net beds, and safe rooms to allow agitation to occur without risk of injury.',
    ),
    QuizQuestion(
      question: 'Why might a neurostimulant such as methylphenidate paradoxically reduce agitation in a TBI patient?',
      options: ['It sedates the patient through dopamine depletion', 'It improves frontal lobe attention and processing speed, reducing confusion-driven agitation', 'It acts as a long-term anxiolytic', 'It directly blocks sympathetic overdrive'],
      correctIndex: 1,
      explanation: 'Agitation often results from profound confusion due to poor attention and slow processing. A neurostimulant can help the frontal lobes function better, allowing the patient to understand their environment and reducing agitation.',
    ),
    QuizQuestion(
      question: 'What is the recommended caloric replacement level for a patient in the acute phase of TBI due to the hypermetabolic state?',
      options: ['50% to 75% of expected metabolic needs', '75% to 100% of expected metabolic needs', '100% to 140% of expected metabolic needs', '140% to 200% of expected metabolic needs'],
      correctIndex: 2,
      explanation: 'Acute TBI triggers a massive hypermetabolic and hypercatabolic state, with energy requirements jumping to 100% to 140% of expected levels due to catecholamine release, cortisol, and increased muscle tone.',
    ),
    QuizQuestion(
      question: 'Which medication is specifically recommended for sympathetic storming (tachycardia, hypertension, diaphoresis) in TBI patients?',
      options: ['Methylphenidate', 'Propranolol', 'Trazodone', 'Valproic acid'],
      correctIndex: 1,
      explanation: 'Propranolol, a beta blocker, is highlighted as a maintenance medication that is effective when there is a sympathetic overdrive component such as storming with tachycardia, hypertension, and diaphoresis.',
    ),
    QuizQuestion(
      question: 'When evaluating an agitated TBI patient, which of the following is described as an often-missed cause of agitation related to medications given in the ICU?',
      options: ['Sundowning', 'Urinary tract infection', 'Iatrogenic withdrawal from sedatives such as fentanyl or midazolam', 'Undiagnosed seizure activity'],
      correctIndex: 2,
      explanation: 'The transcript specifically highlights that iatrogenic withdrawal is frequently missed. Patients who received fentanyl and midazolam drips in the ICU for weeks and then had them abruptly discontinued may experience withdrawal from those same medications.',
    ),
  ]),

  'Traumatic Brain Injury 6': const EpisodeQuiz(episodeTitle: 'Traumatic Brain Injury 6', questions: [
    QuizQuestion(
      question: 'According to the ACRM criteria for mild TBI, which of the following is true?',
      options: ['Loss of consciousness is required for diagnosis', 'Post-traumatic amnesia must exceed 24 hours', 'An alteration in mental status at the time of injury alone can meet the diagnostic criteria', 'A GCS of 12 is consistent with a mild TBI classification'],
      correctIndex: 2,
      explanation: 'The ACRM criteria require at least one of four manifestations: any loss of consciousness, any amnesia before or after the event, any alteration in mental status at the time of injury, or any focal neurologic deficit. Loss of consciousness is not required.',
    ),
    QuizQuestion(
      question: 'What is the upper limit of loss of consciousness duration that still qualifies as a mild TBI?',
      options: ['Less than 15 minutes', 'Less than 30 minutes', 'Less than 60 minutes', 'Less than 24 hours'],
      correctIndex: 1,
      explanation: 'For mild TBI, loss of consciousness must be less than 30 minutes. If the patient is unconscious for 31 minutes or more, the injury is classified as moderate TBI by definition.',
    ),
    QuizQuestion(
      question: 'In the 2016 Berlin consensus graduated return-to-play protocol, which activity is specifically prohibited during step two (light aerobic exercise)?',
      options: ['Walking', 'Stationary cycling', 'Resistance training', 'Swimming'],
      correctIndex: 2,
      explanation: 'Step two allows light aerobic exercise such as walking, swimming, or stationary cycling with heart rate below 70% of max. However, resistance training is specifically prohibited at this stage.',
    ),
    QuizQuestion(
      question: 'Which pharmacologic agent is most associated with improving processing speed in TBI patients?',
      options: ['Amantadine', 'Donepezil', 'Methylphenidate', 'CDP-choline'],
      correctIndex: 2,
      explanation: 'The transcript specifically states that the key phrase to associate with methylphenidate and TBI is processing speed. While it helps with attention broadly, the literature specifically points to benefits in the speed of information processing.',
    ),
    QuizQuestion(
      question: 'What is second impact syndrome and why is it so dangerous?',
      options: ['A delayed seizure occurring weeks after the first TBI', 'A catastrophic loss of cerebral vascular autoregulation after a second head injury sustained before recovery from the first, with mortality near 50%', 'A progressive decline in cognition seen after repeated subconcussive blows over years', 'A rebound increase in intracranial pressure after premature discontinuation of mannitol'],
      correctIndex: 1,
      explanation: 'Second impact syndrome occurs when a still-symptomatic patient sustains a second head injury, triggering complete failure of cerebral vascular autoregulation, massive ICP elevation, brain herniation, and mortality close to 50% with near 100% morbidity in survivors.',
    ),
  ]),
  ...
  'Wheelchair 1': const EpisodeQuiz(episodeTitle: 'Wheelchair 1', questions: [
    QuizQuestion(question: 'For a manual wheelchair, the seat width should equal:', options: ['Hip width plus 2 inches', 'Hip width exactly (no extra space)', 'Hip width plus 1 inch', 'Shoulder width'], correctIndex: 1, explanation: 'For manual wheelchairs, seat width equals hip width with no extra space. This keeps the wheels as close to the body as possible for efficient propulsion and reduced shoulder strain.'),
    QuizQuestion(question: 'What is the hammocking effect caused by a vinyl sling seat?', options: ['The seat bounces during propulsion', 'Gravity pulls the hips into internal rotation and adduction, forcing posterior pelvic tilt and sacral sitting', 'The seat stretches over time becoming too wide', 'The patient slides forward due to low friction'], correctIndex: 1, explanation: 'A sling seat sags like a hammock, pulling the hips into internal rotation/adduction, causing posterior pelvic tilt, sacral sitting, kyphosis, and increased pressure injury risk.'),
    QuizQuestion(question: 'The gap between the front of the wheelchair seat and the back of the knee should be:', options: ['Zero (flush contact)', 'Less than 3 inches', 'Exactly 5 inches', '1 inch or less'], correctIndex: 1, explanation: 'The gap should be less than 3 inches. Too shallow concentrates weight on the ischial tuberosities (pressure injury risk). Too deep compresses the popliteal area causing the patient to slide forward.'),
    QuizQuestion(question: 'For a hemi-height (foot-propelled) wheelchair, how does the seat height formula differ from standard?', options: ['Add 5 inches for clearance', 'Do NOT add the 3-4 inches of ground clearance used in standard chairs', 'Double the cushion height', 'Use standing height instead of leg length'], correctIndex: 1, explanation: 'For foot propellers, the formula is leg length minus compressed cushion height only. Adding ground clearance would leave the feet dangling, unable to reach the floor.'),
    QuizQuestion(question: 'For a power wheelchair, the seat width rule differs from manual. What is it?', options: ['Hip width minus 1 inch', 'Hip width exactly', 'Hip width plus approximately 1 inch', 'Shoulder width plus 2 inches'], correctIndex: 2, explanation: 'Power chair users are not propelling with their arms, so comfort is prioritized. The rule is hip width plus approximately 1 inch for breathing room and weight shifting.'),
  ]),

  'Wheelchair 2': const EpisodeQuiz(episodeTitle: 'Wheelchair 2', questions: [
    QuizQuestion(question: 'Carpeting increases wheelchair rolling resistance by what factor compared to smooth surfaces?', options: ['A factor of 2', 'A factor of 3', 'A factor of 4', 'A factor of 6'], correctIndex: 2, explanation: 'Carpeting increases rolling resistance by a factor of 4 compared to smooth surfaces like tile or wood. Properly inflated pneumatic tires are the best choice for carpeted environments.'),
    QuizQuestion(question: 'The typical camber prescription for everyday wheelchair use is:', options: ['0 degrees (perfectly vertical)', '2 to 5 degrees', '10 to 15 degrees', '20 degrees or more'], correctIndex: 1, explanation: 'For everyday use, 2-5 degrees of camber provides stability, ergonomic push position, and hand protection without making the chair too wide. Higher angles (10-15 degrees) are reserved for sports.'),
    QuizQuestion(question: 'In a one-arm drive wheelchair, how does the patient steer and propel?', options: ['A joystick mounted on one armrest', 'Two handrims on the same wheel - outer rim drives that wheel, inner rim drives the opposite wheel, both together goes straight', 'A lever system like rowing', 'Foot steering with one-handed propulsion'], correctIndex: 1, explanation: 'Two handrims are mounted on one wheel. The outer rim propels that wheel, the inner rim propels the opposite wheel via a special axle, and grabbing both engages a clutch to go straight.'),
    QuizQuestion(question: 'Why are smaller casters (2-4 inches) problematic despite their maneuverability advantage?', options: ['They wear out faster', 'They get caught in small cracks and gaps in sidewalks, causing abrupt stops', 'They are too expensive', 'They add too much weight'], correctIndex: 1, explanation: 'Small casters are extremely maneuverable but get stuck in sidewalk cracks and gaps. Larger casters (5-8 inches) roll over obstacles more easily but reduce turning ability.'),
    QuizQuestion(question: 'For a bilateral lower extremity amputee, what wheelchair modification prevents backward tipping?', options: ['Add extra weight to the footrests', 'Move the rear axle posteriorly to shift the center of gravity forward', 'Use smaller rear wheels', 'Lower the seat height'], correctIndex: 1, explanation: 'Without legs, the center of gravity shifts posteriorly. Moving the rear axle back (or adding anti-tip casters) compensates by shifting the base of support behind the new center of gravity, preventing backward tipping.'),
  ]),
  ...
  'The Board Exam': const EpisodeQuiz(episodeTitle: 'The Board Exam', questions: [
    QuizQuestion(
      question: 'What is the total number of multiple choice questions on part one of the ABPMR board certification exam?',
      options: ['200', '250', '325', '400'],
      correctIndex: 2,
      explanation: 'Part one of the ABPMR written exam consists of 325 multiple choice questions split into two sessions (approximately 165 in the morning and 160 in the afternoon) with a 60-minute break between them.',
    ),
    QuizQuestion(
      question: 'According to the exam content matrix, which two organ system categories together make up approximately 62% of the written board exam?',
      options: ['Neurologic disorders and amputation', 'Musculoskeletal medicine and basic sciences', 'Neurologic disorders and musculoskeletal medicine', 'Rehabilitation problems and patient management'],
      correctIndex: 2,
      explanation: 'Neurologic disorders account for 30% and musculoskeletal medicine accounts for 32% of the exam, combining for 62% of the total content.',
    ),
    QuizQuestion(
      question: 'What is the maximum number of years after completing residency that a graduate (who finished on or after January 1, 2012) has to pass both parts of the ABPMR board exam?',
      options: ['Five years', 'Seven years', 'Ten years', 'There is no time limit'],
      correctIndex: 1,
      explanation: 'Graduates who completed training on or after January 1, 2012 have a seven calendar year window from the completion of residency to pass both part one and part two of the board exam.',
    ),
    QuizQuestion(
      question: 'What must a program director affirm about a resident before that resident is granted admissibility to sit for part one of the boards?',
      options: ['The resident has published at least one peer-reviewed article', 'The resident has demonstrated sufficient competence to enter practice without direct supervision', 'The resident has completed a research project approved by the department', 'The resident has passed all in-training examinations above the 50th percentile'],
      correctIndex: 1,
      explanation: 'The program director must affirm two things: that the resident completed the required training time, and that the resident has demonstrated sufficient competence to enter practice without direct supervision. This evaluation is due by July 1 of the exam year.',
    ),
    QuizQuestion(
      question: 'Where is part two (the oral examination) of the ABPMR board certification exam administered?',
      options: ['At any Pearson Professional Center nationwide', 'At the ABPMR headquarters in Washington DC', 'Only in Rochester, Minnesota', 'At the annual AAPMR conference location'],
      correctIndex: 2,
      explanation: 'Part two, the oral examination, is administered only in Rochester, Minnesota. Candidates must travel there after passing part one and must submit copies of all current, valid, and unrestricted medical licenses.',
    ),
  ]),
};
