...
final Map<String, EpisodeQuiz> quizzes = {
  ...
  // ── Pediatrics 1-11 ──
  'Pediatric Rehabilitation 1': const EpisodeQuiz(episodeTitle: 'Pediatric Rehabilitation 1', questions: [
    QuizQuestion(question: 'Cerebral palsy is defined as a:', options: ['Progressive neurological disorder', 'Non-progressive disorder of movement and posture due to a lesion in the developing brain', 'Genetic muscular disorder', 'Peripheral nerve disease'], correctIndex: 1, explanation: 'CP is a non-progressive disorder of movement and posture resulting from injury to the developing brain (prenatal, perinatal, or early postnatal). While the brain lesion is static, the musculoskeletal manifestations can change over time as the child grows.'),
    QuizQuestion(question: 'The Gross Motor Function Classification System (GMFCS) has how many levels?', options: ['3', '4', '5', '7'], correctIndex: 2, explanation: 'GMFCS has 5 levels: Level I = walks without limitations. Level II = walks with limitations. Level III = walks with assistive device. Level IV = self-mobility with limitations (power wheelchair). Level V = transported in manual wheelchair. The level is relatively stable over time and predicts adult mobility.'),
    QuizQuestion(question: 'The most common type of cerebral palsy is:', options: ['Dyskinetic', 'Ataxic', 'Spastic', 'Hypotonic'], correctIndex: 2, explanation: 'Spastic CP accounts for ~80% of cases. It can be classified by distribution: diplegia (legs > arms), hemiplegia (one side), quadriplegia (all four limbs). Dyskinetic CP (~10-15%) includes dystonic and choreoathetoid types. Ataxic CP (~5%) involves cerebellar dysfunction.'),
    QuizQuestion(question: 'Periventricular leukomalacia (PVL) is the most common cause of CP in:', options: ['Full-term infants', 'Premature infants', 'Post-term infants', 'Adolescents'], correctIndex: 1, explanation: 'PVL: ischemic injury to the periventricular white matter in premature infants. The periventricular region is a watershed zone vulnerable to hypoperfusion. Because motor fibers to the legs run closest to the ventricles, PVL classically causes spastic diplegia (legs > arms).'),
    QuizQuestion(question: 'A child with spastic diplegic CP typically has which motor pattern?', options: ['Upper extremity involvement greater than lower', 'Lower extremity involvement greater than upper, scissoring gait', 'Unilateral involvement only', 'Primarily truncal hypotonia'], correctIndex: 1, explanation: 'Spastic diplegia: bilateral lower extremity involvement greater than upper. Classic pattern: scissoring gait (hip adductor spasticity), toe-walking (ankle plantarflexion spasticity), crouch gait (hip/knee flexion). Associated with prematurity and PVL. Upper extremities may have subtle fine motor deficits.'),
  ]),

  'Pediatric Rehabilitation 2': const EpisodeQuiz(episodeTitle: 'Pediatric Rehabilitation 2', questions: [
    QuizQuestion(question: 'Duchenne muscular dystrophy (DMD) is inherited in which pattern?', options: ['Autosomal dominant', 'Autosomal recessive', 'X-linked recessive', 'Mitochondrial'], correctIndex: 2, explanation: 'DMD is X-linked recessive (dystrophin gene on Xp21). Affects almost exclusively males. 1/3 are new mutations. Onset by age 3-5 with progressive proximal weakness, wheelchair by 12, death by 20s-30s from respiratory/cardiac failure. CPK is massively elevated (10-100x normal).'),
    QuizQuestion(question: 'Gower sign in DMD demonstrates:', options: ['Calf pseudohypertrophy', 'The child walking hands up thighs to rise from the floor due to proximal weakness', 'Winging of the scapula', 'Toe-walking'], correctIndex: 1, explanation: 'Gower sign: the child uses arms to "climb up" their own legs to stand from the floor, compensating for severe hip and knee extensor weakness. It is characteristic (though not pathognomonic) of DMD and reflects proximal muscle weakness that progresses proximally to distally.'),
    QuizQuestion(question: 'Spinal muscular atrophy (SMA) Type I (Werdnig-Hoffmann) presents:', options: ['After age 5 with mild weakness', 'Before 6 months with severe hypotonia and inability to sit', 'At birth with contractures', 'In adolescence with scoliosis'], correctIndex: 1, explanation: 'SMA Type I (Werdnig-Hoffmann): onset before 6 months, severe generalized hypotonia (floppy baby), absent reflexes, tongue fasciculations, never achieve sitting. Autosomal recessive, SMN1 gene deletion. Death typically by age 2 from respiratory failure without treatment. Nusinersen (Spinraza) has changed prognosis.'),
    QuizQuestion(question: 'Brachial plexus birth palsy involving C5-C6 is called:', options: ['Klumpke palsy', 'Erb-Duchenne palsy', 'Total plexus palsy', 'Horner syndrome'], correctIndex: 1, explanation: 'Erb-Duchenne palsy (C5-C6): the "waiter\'s tip" position — shoulder adducted and internally rotated, elbow extended, forearm pronated, wrist flexed. Most common brachial plexus birth injury (~75%). Risk factors: large birth weight, shoulder dystocia. Most recover spontaneously by 3-6 months.'),
    QuizQuestion(question: 'Myelomeningocele most commonly occurs at which spinal level?', options: ['Cervical', 'Thoracic', 'Lumbar/lumbosacral', 'Sacral only'], correctIndex: 2, explanation: 'Myelomeningocele (open spina bifida) most commonly occurs at the lumbar/lumbosacral level. The functional level determines ambulatory potential: thoracic = wheelchair, high lumbar (L1-L2) = household ambulation with RGO/KAFO, low lumbar (L3-L4) = community ambulation with AFOs, sacral = near-normal ambulation.'),
  ]),

  'Pediatric Rehabilitation 3': const EpisodeQuiz(episodeTitle: 'Pediatric Rehabilitation 3', questions: [
    QuizQuestion(question: 'The Arnold-Chiari II malformation associated with myelomeningocele involves:', options: ['Upward herniation of the cerebellar tonsils', 'Downward herniation of the cerebellar tonsils and brainstem through the foramen magnum', 'Agenesis of the corpus callosum', 'Dandy-Walker malformation'], correctIndex: 1, explanation: 'Chiari II: downward displacement of the cerebellar vermis, tonsils, and brainstem through the foramen magnum. It is present in virtually all myelomeningocele patients. Can cause hydrocephalus (90% require VP shunt), brainstem dysfunction (stridor, apnea, swallowing difficulties), and syringomyelia.'),
    QuizQuestion(question: 'Folic acid supplementation to prevent neural tube defects should begin:', options: ['During the second trimester', 'At least 1 month before conception', 'After the baby is born', 'Only if there is a family history'], correctIndex: 1, explanation: 'Folic acid 0.4 mg/day recommended for all women of childbearing age starting at least 1 month before conception. Women with prior NTD-affected pregnancy should take 4 mg/day. Neural tube closure occurs by day 28 of gestation (often before pregnancy is recognized), making preconception supplementation critical.'),
    QuizQuestion(question: 'Latex allergy is a major concern in myelomeningocele because:', options: ['These children are never exposed to latex', 'Repeated surgical procedures cause sensitization to latex proteins', 'Latex causes neural tube defects', 'It only affects adults'], correctIndex: 1, explanation: 'Myelomeningocele patients have up to 73% latex sensitization rate due to repeated early surgical exposures (shunt placements, closures, catheterizations). Reactions range from contact dermatitis to anaphylaxis. Strict latex-free precautions are mandatory from birth. Cross-reactivity exists with bananas, kiwi, avocado, and chestnuts.'),
    QuizQuestion(question: 'Tethered cord syndrome in spina bifida presents with:', options: ['Improved motor function', 'Progressive scoliosis, back pain, changing gait, and declining bladder function', 'Seizures', 'Upper extremity weakness'], correctIndex: 1, explanation: 'Tethered cord: the spinal cord is abnormally fixed to surrounding structures, and as the child grows, the cord is stretched. Presents with progressive scoliosis, back/leg pain, changing gait pattern, worsening bladder function, or new foot deformities. MRI confirms; surgical untethering is indicated.'),
    QuizQuestion(question: 'A child with L4 myelomeningocele level would have:', options: ['No lower extremity function', 'Intact quadriceps (knee extension) but weak/absent ankle function', 'Normal walking ability', 'Only hip flexion'], correctIndex: 1, explanation: 'L4 level: intact hip flexion (L1-L2), knee extension (L3-L4), and some ankle dorsiflexion (L4). Absent ankle plantarflexion (S1) and hip extension (L5-S1). These children are typically community ambulators with AFOs. Hip subluxation risk due to muscle imbalance (flexors > extensors).'),
  ]),

  'Pediatric Rehabilitation 4': const EpisodeQuiz(episodeTitle: 'Pediatric Rehabilitation 4', questions: [
    QuizQuestion(question: 'Primitive reflexes that should integrate (disappear) by 6 months include:', options: ['Landau and parachute reflexes', 'Moro and asymmetric tonic neck reflex (ATNR)', 'Righting reflexes', 'Equilibrium reactions'], correctIndex: 1, explanation: 'Moro reflex (startle response) integrates by 5-6 months. ATNR (fencing posture) integrates by 6 months. Persistence beyond these ages suggests CNS pathology (CP). Protective/parachute reflexes EMERGE at 6-9 months and persist throughout life. Righting and equilibrium reactions also develop later and persist.'),
    QuizQuestion(question: 'A typically developing child should be able to sit independently by:', options: ['3 months', '6 months', '9 months', '12 months'], correctIndex: 1, explanation: 'Gross motor milestones: head control 3 months, roll over 4-5 months, sit independently 6 months, crawl 8-9 months, pull to stand 9-10 months, walk independently 12 months (range 9-15 months). Delays beyond 2 standard deviations warrant evaluation.'),
    QuizQuestion(question: 'Down syndrome (trisomy 21) is associated with which musculoskeletal concern requiring screening?', options: ['Scoliosis only', 'Atlantoaxial instability (C1-C2)', 'Hip avascular necrosis', 'Pathologic long bone fractures'], correctIndex: 1, explanation: 'Atlantoaxial instability (AAI): present in ~15% of Down syndrome patients due to ligamentous laxity. ADI (atlanto-dens interval) >5mm on lateral flexion/extension X-rays is abnormal. Screening required before participation in sports (Special Olympics). Symptomatic AAI requires surgical fusion. Other concerns: hypotonia, cardiac defects, hypothyroidism.'),
    QuizQuestion(question: 'Constraint-induced movement therapy (CIMT) in pediatric hemiplegia involves:', options: ['Constraining the affected limb', 'Constraining the unaffected limb to force use of the affected limb', 'Bilateral arm training only', 'Surgical tendon transfer'], correctIndex: 1, explanation: 'CIMT: the unaffected hand is restrained (cast or mitt) for a period while intensive therapy targets the affected hand. This combats learned non-use and promotes cortical reorganization. Modified CIMT protocols (fewer hours, intermittent constraint) are more practical for children. Evidence supports improved hand function in hemiplegic CP.'),
    QuizQuestion(question: 'The Bayley Scales of Infant Development assess:', options: ['Only motor skills', 'Cognitive, language, and motor development in infants 1-42 months', 'Academic achievement', 'Adaptive behavior only'], correctIndex: 1, explanation: 'Bayley-IV: comprehensive developmental assessment for infants/toddlers (1-42 months). Five domains: cognitive, language (receptive + expressive), motor (fine + gross), social-emotional, and adaptive behavior. It is the gold standard for identifying developmental delays and qualifying children for early intervention services.'),
  ]),

  'Pediatric Rehabilitation 5': const EpisodeQuiz(episodeTitle: 'Pediatric Rehabilitation 5', questions: [
    QuizQuestion(question: 'Autism spectrum disorder is characterized by deficits in:', options: ['Motor coordination only', 'Social communication/interaction AND restricted/repetitive behaviors', 'Language only', 'Cognitive function exclusively'], correctIndex: 1, explanation: 'DSM-5 ASD criteria require deficits in BOTH: (1) social communication and social interaction across contexts, and (2) restricted, repetitive patterns of behavior, interests, or activities. Symptoms must be present in early development. Severity levels 1-3 (requiring support → requiring very substantial support).'),
    QuizQuestion(question: 'Developmental dysplasia of the hip (DDH) is best screened for using:', options: ['X-ray at birth', 'Barlow and Ortolani maneuvers in newborns; ultrasound at 4-6 weeks', 'MRI at 6 months', 'CT scan at 1 year'], correctIndex: 1, explanation: 'Barlow (adduction/posterior pressure dislocates an unstable hip) and Ortolani (abduction reduces a dislocated hip with a "clunk"). Ultrasound is the imaging modality of choice before 4-6 months (femoral head is cartilaginous, not visible on X-ray). Risk factors: breech presentation, female sex, family history. Pavlik harness is first-line treatment.'),
    QuizQuestion(question: 'Legg-Calvé-Perthes disease is:', options: ['A fracture of the femoral neck', 'Idiopathic avascular necrosis of the femoral head in children ages 4-10', 'Slipped capital femoral epiphysis', 'Hip dysplasia in newborns'], correctIndex: 1, explanation: 'Legg-Calvé-Perthes: idiopathic AVN of the femoral head in children (peak 4-8 years), 4-5x more common in boys. Presents with limp, hip/knee pain, limited ROM (especially internal rotation and abduction). Management: containment of the femoral head within the acetabulum (bracing or surgery). Younger onset (<6 years) = better prognosis.'),
    QuizQuestion(question: 'Juvenile idiopathic arthritis (JIA) is the most common chronic rheumatic disease in children. The most common subtype is:', options: ['Systemic JIA', 'Polyarticular JIA', 'Oligoarticular (pauciarticular) JIA', 'Enthesitis-related JIA'], correctIndex: 2, explanation: 'Oligoarticular JIA (≤4 joints in first 6 months) is most common (~50%). Typically affects large joints (knee) in young girls. KEY complication: uveitis (asymptomatic eye inflammation) — requires regular slit-lamp screening. ANA-positive patients at highest uveitis risk. Polyarticular affects ≥5 joints. Systemic (Still disease) has quotidian fevers and salmon-colored rash.'),
    QuizQuestion(question: 'Torticollis in an infant is most commonly caused by:', options: ['Cervical spine fracture', 'Congenital muscular torticollis (SCM tightness)', 'Brain tumor', 'Meningitis'], correctIndex: 1, explanation: 'Congenital muscular torticollis: tightness/fibrosis of the SCM causes head tilt toward the affected side with chin rotation to the opposite side. Often from intrauterine positioning. May have a palpable SCM mass ("sternocleidomastoid tumor"). Treatment: stretching exercises, positioning. Most resolve by 1 year. Plagiocephaly (skull flattening) can co-occur.'),
  ]),

  'Pediatric Rehabilitation 6': const EpisodeQuiz(episodeTitle: 'Pediatric Rehabilitation 6', questions: [
    QuizQuestion(question: 'Osgood-Schlatter disease affects:', options: ['The hip joint', 'The tibial tuberosity apophysis in adolescents', 'The lumbar spine', 'The shoulder joint'], correctIndex: 1, explanation: 'Osgood-Schlatter: traction apophysitis of the tibial tubercle from repetitive quadriceps contraction through the patellar tendon. Most common in active adolescents during growth spurts (boys 12-14, girls 10-12). Treatment: activity modification, quad stretching, ice. Self-limiting — resolves when growth plate closes.'),
    QuizQuestion(question: 'Sever disease is a traction apophysitis affecting:', options: ['The tibial tuberosity', 'The calcaneal apophysis (heel)', 'The medial epicondyle', 'The iliac crest'], correctIndex: 1, explanation: 'Sever disease (calcaneal apophysitis): traction injury at the Achilles tendon insertion on the calcaneal growth plate. Most common cause of heel pain in active children ages 8-14. Bilateral in 60%. Treatment: heel cups, Achilles stretching, activity modification. Self-limiting with skeletal maturity.'),
    QuizQuestion(question: 'The Blount disease involves:', options: ['Femoral head avascular necrosis', 'Pathologic tibia vara (bowleg) from growth plate disturbance of the proximal medial tibia', 'Scoliosis', 'Wrist fracture'], correctIndex: 1, explanation: 'Blount disease: abnormal endochondral bone formation of the medial proximal tibial physis causing progressive tibia vara (bowleg). Distinguished from physiologic bowing (improves by age 3). Infantile type (1-3 years, often bilateral, associated with obesity/early walking) and adolescent type (unilateral). Bracing for infantile; surgery for severe/adolescent.'),
    QuizQuestion(question: 'Slipped capital femoral epiphysis (SCFE) typically presents in:', options: ['Neonates', 'Overweight adolescents with hip or knee pain and limited internal rotation', 'Toddlers learning to walk', 'Elderly patients'], correctIndex: 1, explanation: 'SCFE: the femoral epiphysis slips posteriorly and medially relative to the metaphysis through the weakened growth plate. Classic patient: overweight adolescent (10-16 years), boys > girls. Presents with hip, groin, or referred knee pain and obligatory external rotation with hip flexion. Emergency: NO weight-bearing; surgical pinning in situ.'),
    QuizQuestion(question: 'In pediatric rehabilitation, the Denver Developmental Screening Test II assesses:', options: ['Intelligence quotient only', 'Four domains: gross motor, fine motor/adaptive, language, personal-social', 'Academic readiness', 'Behavioral problems only'], correctIndex: 1, explanation: 'Denver II: screening tool for developmental delays in children 0-6 years across 4 domains: gross motor, fine motor-adaptive, language, and personal-social. Results are categorized as normal, suspect, or untestable. It is a SCREENING tool (not diagnostic) — abnormal results require comprehensive evaluation with tools like the Bayley Scales.'),
  ]),

  'Pediatric Rehabilitation 7': const EpisodeQuiz(episodeTitle: 'Pediatric Rehabilitation 7', questions: [
    QuizQuestion(question: 'Spastic diplegia in CP is most commonly associated with which brain lesion?', options: ['Cortical infarct', 'Periventricular leukomalacia (PVL)', 'Cerebellar hemorrhage', 'Basal ganglia injury'], correctIndex: 1, explanation: 'PVL is the hallmark lesion of spastic diplegia. The periventricular white matter is a vascular watershed zone vulnerable in premature infants. Motor fibers to the lower extremities pass closest to the ventricles, explaining why legs are affected more than arms.'),
    QuizQuestion(question: 'Botulinum toxin in pediatric CP is most commonly used to treat:', options: ['Generalized weakness', 'Focal spasticity (e.g., equinus from gastrocnemius spasticity)', 'Seizures', 'Intellectual disability'], correctIndex: 1, explanation: 'Botox in pediatric CP targets focal spasticity to improve function and delay surgery. Most common target: gastrocnemius/soleus for equinus (toe-walking). Other targets: hamstrings (crouch gait), hip adductors (scissoring). It is an adjunct to stretching, serial casting, and orthotics. Effects last 3-6 months; repeated injections needed.'),
    QuizQuestion(question: 'Hip surveillance in cerebral palsy is important because:', options: ['All CP children eventually need hip replacement', 'Spastic hip muscles cause progressive subluxation/dislocation, especially in GMFCS IV-V', 'Hip fractures are common in CP', 'It is only needed in hemiplegic CP'], correctIndex: 1, explanation: 'Hip displacement in CP: spastic hip flexors/adductors pull the femoral head out of the acetabulum progressively. GMFCS V children have ~90% risk of hip displacement. Screening: AP pelvis X-rays measuring migration percentage. Preventive management: stretching, botox, bracing. Surgical reconstruction if migration percentage >40-50%.'),
    QuizQuestion(question: 'Intrathecal baclofen (ITB) pump in pediatric CP is best indicated for:', options: ['Mild spasticity in GMFCS I', 'Severe generalized spasticity (GMFCS IV-V) failing oral medications', 'Dystonic CP only', 'Ataxic CP'], correctIndex: 1, explanation: 'ITB in pediatric CP: best for severe generalized spasticity in non-ambulatory children (GMFCS IV-V) who have failed oral medications. Benefits: improved comfort, ease of care, reduced orthopedic deformities. A screening trial (lumbar puncture with baclofen bolus) must show benefit before pump implantation.'),
    QuizQuestion(question: 'Single-event multilevel surgery (SEMLS) in CP involves:', options: ['Performing one surgery at a time over several years', 'Correcting all significant deformities in a single surgical session', 'Only soft tissue procedures', 'Surgery before age 2'], correctIndex: 1, explanation: 'SEMLS: multiple orthopedic procedures (tendon lengthenings, transfers, bony corrections) performed in one session, typically at age 7-10 when gait analysis is reliable. Advantages: single anesthesia, single rehabilitation period, addresses crouch gait pattern comprehensively. Requires intensive post-op rehab (6-12 months).'),
  ]),

  'Pediatric Rehabilitation 8': const EpisodeQuiz(episodeTitle: 'Pediatric Rehabilitation 8', questions: [
    QuizQuestion(question: 'Klumpke palsy (brachial plexus birth injury) involves which nerve roots?', options: ['C5-C6', 'C7', 'C8-T1', 'C3-C5'], correctIndex: 2, explanation: 'Klumpke palsy: C8-T1 injury affecting hand intrinsics and finger/wrist flexors. Presents with a claw hand deformity. Less common than Erb palsy. If T1 sympathetic fibers are involved, Horner syndrome (ptosis, miosis, anhidrosis) occurs. Prognosis is generally worse than Erb palsy.'),
    QuizQuestion(question: 'In pediatric TBI, children differ from adults in that:', options: ['Children never recover from TBI', 'Younger children (<2 years) with severe TBI have worse outcomes than older children with similar injuries', 'Children always recover completely', 'There is no difference'], correctIndex: 1, explanation: 'Plasticity is a double-edged sword: while mild pediatric TBI may recover well, severe TBI in very young children (<2 years) disrupts fundamental brain development and has worse outcomes than similar injuries in older children/adults. Deficits may not be apparent until developmental demands increase (e.g., executive function deficits emerging in adolescence).'),
    QuizQuestion(question: 'Duchenne muscular dystrophy is confirmed by which test?', options: ['EMG alone', 'Genetic testing for dystrophin gene mutations (or muscle biopsy showing absent dystrophin)', 'Nerve conduction studies', 'CT scan of muscles'], correctIndex: 1, explanation: 'DMD diagnosis: elevated CPK (screening) → genetic testing (first-line confirmatory) showing dystrophin gene deletion/duplication/point mutation on Xp21. Muscle biopsy (absent dystrophin on immunostaining) is used when genetic testing is inconclusive. EMG shows myopathic pattern but is not diagnostic.'),
    QuizQuestion(question: 'Corticosteroids (prednisone/deflazacort) in DMD are used to:', options: ['Cure the disease', 'Slow disease progression, prolong ambulation, and delay scoliosis', 'Build muscle mass', 'Treat infections'], correctIndex: 1, explanation: 'Steroids are the standard of care in DMD: prolong independent ambulation by 2-3 years, delay scoliosis, preserve pulmonary function, and delay cardiomyopathy. Side effects: weight gain, osteoporosis, cataracts, behavioral changes. Deflazacort may have fewer weight gain side effects. Initiate when motor plateau is reached (typically 4-6 years).'),
    QuizQuestion(question: 'A child who walks on toes bilaterally, has tight heel cords, and was born premature at 28 weeks most likely has:', options: ['Muscular dystrophy', 'Spastic diplegic CP', 'Autism spectrum disorder', 'Down syndrome'], correctIndex: 1, explanation: 'Bilateral toe-walking + tight heel cords + prematurity = classic spastic diplegic CP from periventricular leukomalacia. The spastic gastrocnemius/soleus causes equinus gait. Treatment: stretching, AFOs, botulinum toxin, and potentially surgical lengthening. Always consider the full clinical picture before diagnosing.'),
  ]),

  'Pediatric Rehabilitation 9': const EpisodeQuiz(episodeTitle: 'Pediatric Rehabilitation 9', questions: [
    QuizQuestion(question: 'The WeeFIM (Functional Independence Measure for Children) assesses:', options: ['Only motor function', 'Motor and cognitive functional independence in children 6 months to 7 years', 'Academic performance', 'Behavioral problems'], correctIndex: 1, explanation: 'WeeFIM: pediatric version of the FIM, assessing 18 items across self-care, mobility, and cognition domains. Each item scored 1-7 (total 18-126). Used for children 6 months to 7 years (or older children with developmental disabilities functioning below age 7). Tracks functional progress in rehabilitation.'),
    QuizQuestion(question: 'Idiopathic toe-walking differs from CP-related toe-walking because:', options: ['It is always bilateral', 'The child CAN walk flat-footed when asked, and there are no UMN signs', 'It is more severe', 'It always requires surgery'], correctIndex: 1, explanation: 'Idiopathic toe-walking: diagnosis of exclusion. Children can walk flat-footed when asked (volitional), have full passive ankle dorsiflexion, normal neurological exam (no spasticity, hyperreflexia, or clonus), and normal development. It is a habit. Treatment: stretching, serial casting if heel cords tighten. Must rule out mild CP, muscular dystrophy, and autism.'),
    QuizQuestion(question: 'Neonatal brachial plexus palsy that fails to recover biceps function by 3-6 months should be considered for:', options: ['Continued observation only', 'Microsurgical nerve repair/grafting', 'Amputation', 'Botulinum toxin injection'], correctIndex: 1, explanation: 'If biceps function (elbow flexion against gravity) does not recover by 3-6 months, the prognosis for spontaneous recovery is poor, and microsurgical intervention (nerve grafting, neurotization) should be considered. Earlier surgery (by 6-9 months) generally yields better outcomes. Most Erb palsy recovers by 3 months; those that do not are surgical candidates.'),
    QuizQuestion(question: 'Transitional care in pediatric rehabilitation refers to:', options: ['Moving between hospital floors', 'Planned transition of adolescents with disabilities from pediatric to adult healthcare systems', 'Changing therapists', 'Moving from ICU to rehab unit'], correctIndex: 1, explanation: 'Transition: planned process of moving adolescents/young adults with chronic conditions from pediatric to adult healthcare. Should begin by age 12-14. Addresses medical management, self-advocacy, vocational planning, sexuality, and independence. Poor transition leads to gaps in care, lost to follow-up, and preventable complications.'),
    QuizQuestion(question: 'Congenital limb deficiency classification uses:', options: ['The Gustilo classification', 'The ISO/ISPO classification system (transverse vs. longitudinal)', 'The Neer classification', 'The Salter-Harris classification'], correctIndex: 1, explanation: 'Congenital limb deficiencies are classified as transverse (limb appears amputated at a specific level — all elements distal are absent) or longitudinal (specific bone/ray is absent — e.g., radial deficiency, fibular hemimelia). This replaces old eponymous terms. Fibular hemimelia is the most common long bone deficiency.'),
  ]),

  'Pediatric Rehabilitation 10': const EpisodeQuiz(episodeTitle: 'Pediatric Rehabilitation 10', questions: [
    QuizQuestion(question: 'Duchenne vs. Becker muscular dystrophy: the key difference is:', options: ['Different genes', 'Duchenne has absent dystrophin; Becker has reduced/abnormal dystrophin (in-frame vs. out-of-frame mutations)', 'One affects girls, the other boys', 'They have identical presentations'], correctIndex: 1, explanation: 'Both involve the dystrophin gene on Xp21. DMD: out-of-frame deletion → NO functional dystrophin → severe, wheelchair by 12. BMD: in-frame deletion → reduced/truncated but partially functional dystrophin → milder, ambulation into 20s-30s. This is the "reading frame hypothesis."'),
    QuizQuestion(question: 'Scoliosis screening in neuromuscular conditions is important because:', options: ['Scoliosis is always cosmetic', 'Progressive curves can compromise respiratory function and seating', 'It only occurs in adults', 'All curves require immediate surgery'], correctIndex: 1, explanation: 'Neuromuscular scoliosis (CP, DMD, SMA) tends to be progressive, long C-curves involving the pelvis. Unlike idiopathic scoliosis, bracing is rarely effective. Severe curves compromise respiratory function (already impaired in NMD), complicate seating/positioning, and cause pain. Spinal fusion is often needed when curves exceed 40-50° in non-ambulatory patients.'),
    QuizQuestion(question: 'Febrile seizures in children are:', options: ['Always indicative of epilepsy', 'Common (2-5% of children), typically benign, occurring with fever in ages 6 months to 5 years', 'Always require lifelong anticonvulsants', 'Only occur in children with brain damage'], correctIndex: 1, explanation: 'Simple febrile seizures: generalized, <15 minutes, single occurrence in 24 hours, age 6mo-5yr. No increased risk of epilepsy (only slightly above baseline). Complex febrile seizures (focal, prolonged, or recurrent) carry slightly higher epilepsy risk. Most children need reassurance only, not anticonvulsant prophylaxis.'),
    QuizQuestion(question: 'Early intervention services for developmental delays are mandated by:', options: ['The Americans with Disabilities Act only', 'IDEA Part C (Individuals with Disabilities Education Act) for children birth to 3 years', 'Medicare', 'No federal law mandates this'], correctIndex: 1, explanation: 'IDEA Part C: federal mandate for early intervention services for infants/toddlers (0-3 years) with developmental delays or conditions with high probability of delay. Services include PT, OT, speech, and family support. Individualized Family Service Plan (IFSP) is developed. Part B covers ages 3-21 with an IEP (Individualized Education Program).'),
    QuizQuestion(question: 'Pediatric acquired brain injury rehabilitation differs from adult TBI rehabilitation in that:', options: ['Children never need rehabilitation', 'The developing brain has both greater plasticity potential and vulnerability to disrupting developmental trajectories', 'Recovery principles are identical', 'Only children over 12 benefit from rehabilitation'], correctIndex: 1, explanation: 'Pediatric ABI: greater neuroplasticity can aid recovery, but injury disrupts ongoing brain development. Deficits may not be apparent immediately ("growing into deficits") — executive function, social cognition, and academic problems often emerge years later. Long-term follow-up is critical. Family/school reintegration and educational accommodations are essential components.'),
  ]),

  'Pediatric Rehabilitation 11': const EpisodeQuiz(episodeTitle: 'Pediatric Rehabilitation 11', questions: [
    QuizQuestion(question: 'Cerebral palsy classification by movement type includes all EXCEPT:', options: ['Spastic', 'Dyskinetic (dystonic/choreoathetoid)', 'Ataxic', 'Peripheral neuropathic'], correctIndex: 3, explanation: 'CP is classified by motor type: spastic (~80%), dyskinetic (10-15%, includes dystonic and choreoathetoid subtypes from basal ganglia injury), ataxic (~5%, from cerebellar injury), and mixed. Peripheral neuropathic is NOT a CP classification — CP is by definition a central (brain) lesion.'),
    QuizQuestion(question: 'The Pediatric Evaluation of Disability Inventory (PEDI) measures:', options: ['IQ only', 'Functional capabilities and caregiver assistance in self-care, mobility, and social function', 'Academic achievement', 'Spasticity severity'], correctIndex: 1, explanation: 'PEDI (now PEDI-CAT computer adaptive test): measures functional performance in children ages 6 months to 7.5 years (or older with disabilities). Three domains: self-care, mobility, social/cognitive. Assesses capability, caregiver assistance level, and environmental modifications. Used for program planning and outcome measurement.'),
    QuizQuestion(question: 'Spina bifida occulta differs from myelomeningocele in that:', options: ['It is more severe', 'The bony defect is present but the spinal cord and meninges are NOT exposed', 'It always requires surgery', 'It causes complete paraplegia'], correctIndex: 1, explanation: 'Spina bifida occulta: incomplete fusion of posterior vertebral arch with intact skin covering. Often incidental finding on X-ray. Usually asymptomatic. May have cutaneous markers (hairy patch, dimple, lipoma). Myelomeningocele: open defect with exposed spinal cord/meninges = most severe form with significant neurological deficits.'),
    QuizQuestion(question: 'Hydrocephalus in myelomeningocele is treated with:', options: ['Medication only', 'Ventriculoperitoneal (VP) shunt', 'Observation', 'Lumbar puncture series'], correctIndex: 1, explanation: 'VP shunt is the standard treatment for hydrocephalus in myelomeningocele (needed in ~90% due to Chiari II malformation). Shunt malfunction is a lifelong risk: signs include headache, vomiting, lethargy, bulging fontanelle (infants), and sunsetting eyes. Endoscopic third ventriculostomy (ETV) is an alternative in select patients.'),
    QuizQuestion(question: 'Selective dorsal rhizotomy (SDR) in cerebral palsy is most appropriate for:', options: ['All types of CP', 'Spastic diplegic CP (GMFCS II-III) with good underlying strength', 'Purely dystonic CP', 'Ataxic CP'], correctIndex: 1, explanation: 'SDR best candidates: spastic diplegia, GMFCS II-III, age 4-8 years, good underlying strength beneath the spasticity, no fixed contractures, no significant dystonia, and motivated family for intensive post-operative rehabilitation (12+ months). It permanently reduces spasticity but requires strength to be present for functional improvement.'),
  ]),

  // ── Prosthetics & Orthotics 1-10 ──
  'Prosthetics and Orthotics 1': const EpisodeQuiz(episodeTitle: 'Prosthetics and Orthotics 1', questions: [
    QuizQuestion(question: 'The most common level of lower extremity amputation is:', options: ['Above knee (transfemoral)', 'Below knee (transtibial)', 'Hip disarticulation', 'Syme amputation'], correctIndex: 1, explanation: 'Transtibial (below-knee) amputation is the most common level. It preserves the knee joint, which dramatically improves prosthetic ambulation potential and reduces energy expenditure compared to transfemoral. The ideal residual limb length is middle to distal third of the tibia.'),
    QuizQuestion(question: 'The leading cause of lower extremity amputation in the US is:', options: ['Trauma', 'Peripheral vascular disease/diabetes', 'Cancer', 'Congenital deficiency'], correctIndex: 1, explanation: 'Peripheral vascular disease (PVD) and diabetes account for ~80% of all lower extremity amputations. The dysvascular population tends to be older with significant comorbidities (cardiac disease, renal disease), which affects rehabilitation potential. Trauma is the leading cause in younger patients.'),
    QuizQuestion(question: 'A rigid post-operative dressing after transtibial amputation provides all EXCEPT:', options: ['Edema control', 'Protection from trauma', 'Immediate prosthetic fitting capability', 'Increased risk of contracture'], correctIndex: 3, explanation: 'Rigid dressings (immediate post-op prosthesis): control edema (compression), protect the residual limb from trauma, allow early weight-bearing, reduce phantom pain, and help prevent knee flexion contracture by maintaining extension. They REDUCE (not increase) contracture risk.'),
    QuizQuestion(question: 'The energy cost of ambulation with a unilateral transfemoral prosthesis compared to normal is approximately:', options: ['10% increase', '25% increase', '40-65% increase', '100% increase'], correctIndex: 2, explanation: 'Energy expenditure: unilateral transtibial = 10-25% increase. Unilateral transfemoral = 40-65% increase. Bilateral transtibial = 40-100% increase. Bilateral transfemoral = up to 280% increase. Higher amputation level = greater energy cost. Dysvascular patients often cannot meet the energy demands of transfemoral prosthetic ambulation.'),
    QuizQuestion(question: 'A flexion contracture of the hip after transfemoral amputation is primarily caused by:', options: ['Socket design', 'Unopposed hip flexor pull (iliopsoas) with loss of hip extensors', 'Prosthetic malalignment', 'Phantom limb pain'], correctIndex: 1, explanation: 'Hip flexion contracture: the gluteus maximus insertion is partially lost with the amputation, creating an imbalance with the intact iliopsoas. Prolonged sitting (wheelchair) compounds this. Prevention: prone lying 20-30 min 2-3x/day, hip extension stretching, avoiding prolonged hip flexion. The prosthetic socket must accommodate any existing contracture.'),
  ]),

  'Prosthetics and Orthotics 2': const EpisodeQuiz(episodeTitle: 'Prosthetics and Orthotics 2', questions: [
    QuizQuestion(question: 'Phantom limb pain (PLP) differs from residual limb pain in that:', options: ['PLP is always worse', 'PLP is perceived in the missing limb; residual limb pain is at the amputation site', 'They are the same thing', 'PLP only occurs in upper extremity amputees'], correctIndex: 1, explanation: 'Phantom limb PAIN: painful sensations (burning, cramping, shooting) perceived in the MISSING portion of the limb. Phantom SENSATION (non-painful awareness of missing limb) is nearly universal. Residual limb pain: pain AT the stump (neuroma, bone spur, skin breakdown, infection). Treatment differs: PLP responds to mirror therapy, gabapentin, TCAs; residual limb pain needs local treatment.'),
    QuizQuestion(question: 'Mirror therapy for phantom limb pain works by:', options: ['Distracting the patient', 'Providing visual feedback of the intact limb that "tricks" the brain into perceiving normal movement of the missing limb', 'Strengthening the residual limb', 'Reducing edema'], correctIndex: 1, explanation: 'Mirror therapy: the patient views the reflection of the intact limb moving, creating a visual illusion that the amputated limb is present and moving normally. This is thought to resolve the conflict between motor commands and absent proprioceptive feedback (cortical remapping), reducing phantom pain. Strong evidence supports its efficacy.'),
    QuizQuestion(question: 'Total contact socket design is important in transtibial prosthetics because:', options: ['It looks better cosmetically', 'It distributes forces evenly, prevents edema, and improves proprioception', 'It is cheaper to manufacture', 'It allows for growth in pediatric patients'], correctIndex: 1, explanation: 'Total surface bearing (TSB) sockets distribute pressure evenly across the entire residual limb surface, preventing pressure concentration that causes skin breakdown. Benefits: edema control, improved proprioceptive feedback, better suspension, and more comfortable weight-bearing. Pressure-tolerant areas bear more load; pressure-sensitive areas are relieved.'),
    QuizQuestion(question: 'The patellar tendon-bearing (PTB) socket loads weight primarily on:', options: ['The distal tibia', 'The patellar tendon, medial tibial flare, and anterior compartment musculature', 'The fibular head', 'The hamstring tendons'], correctIndex: 1, explanation: 'PTB socket: primary weight-bearing on the patellar tendon (pressure-tolerant), with additional load on the medial tibial flare and anteromedial tibial surface. Pressure-sensitive areas (fibular head, tibial crest, distal tibia) are relieved. The PTB design has been largely replaced by TSB sockets but remains a board exam staple.'),
    QuizQuestion(question: 'Knee flexion during stance phase in a transtibial prosthesis is controlled by:', options: ['The cosmetic cover', 'Alignment — positioning the socket anterior to the foot creates knee extension moment', 'A mechanical knee lock', 'Hip flexor strength only'], correctIndex: 1, explanation: 'Prosthetic alignment controls knee stability. The ground reaction force (GRF) vector relative to the knee axis determines flexion/extension moment. Anterior socket placement (or posterior foot placement) keeps GRF anterior to knee = extension moment (stable). Conversely, posterior GRF creates flexion moment (buckling risk).'),
  ]),

  'Prosthetics and Orthotics 3': const EpisodeQuiz(episodeTitle: 'Prosthetics and Orthotics 3', questions: [
    QuizQuestion(question: 'A SACH (Solid Ankle Cushion Heel) foot is best for:', options: ['Active runners', 'Low-activity level amputees who need a stable, durable foot', 'Bilateral transfemoral amputees', 'Pediatric patients who need adjustability'], correctIndex: 1, explanation: 'SACH foot: simple, durable, low-maintenance, no moving parts. The compressible heel cushion simulates plantarflexion at heel strike. Best for K1-K2 level ambulators (household/limited community). Limitations: no energy return, no multi-axial motion, poor on uneven terrain.'),
    QuizQuestion(question: 'The Medicare Functional Classification Levels (K-levels) range from:', options: ['K0 to K4', 'K1 to K5', 'K0 to K3', 'Level 1 to Level 10'], correctIndex: 0, explanation: 'K-levels: K0 = non-ambulatory (no prosthetic potential). K1 = household ambulator (limited). K2 = limited community ambulator (low-level variable cadence). K3 = community ambulator (variable cadence, most environmental barriers). K4 = exceeds basic ambulation (high-impact activities, sports). K-level determines which prosthetic components are covered.'),
    QuizQuestion(question: 'A microprocessor knee (e.g., C-Leg) provides which advantage over mechanical knees?', options: ['Lower cost', 'Real-time adjustment of swing and stance resistance based on walking speed and terrain', 'Lighter weight', 'Simpler maintenance'], correctIndex: 1, explanation: 'Microprocessor knees use sensors and algorithms to continuously adjust hydraulic resistance during both stance (stumble recovery, stair descent) and swing (speed-responsive cadence). Benefits: reduced falls, improved confidence, better stair/ramp navigation, variable walking speed. Covered for K3-K4 level ambulators. More expensive and heavier than mechanical options.'),
    QuizQuestion(question: 'A transfemoral amputee exhibiting lateral trunk lean toward the prosthetic side during stance likely has:', options: ['A socket that is too tight', 'Weak hip abductors on the amputated side (Trendelenburg)', 'An excessively long prosthesis', 'A knee that flexes too easily'], correctIndex: 1, explanation: 'Lateral trunk lean (abductor lurch): compensatory lean toward the prosthetic side to place the center of gravity over the support base. Causes: weak hip abductors (most common), prosthesis too short, or lateral wall of socket too high/uncomfortable. If the prosthesis is too long, the patient vaults on the sound side instead.'),
    QuizQuestion(question: 'Suspension methods for transtibial prostheses include all EXCEPT:', options: ['Suction (liner with valve)', 'Pin/shuttle lock liner', 'Supracondylar cuff', 'Harness with figure-8 strap'], correctIndex: 3, explanation: 'Transtibial suspension: suction (seal-in liner, most popular), pin/shuttle lock (pin on distal liner clicks into socket), supracondylar cuff/strap, sleeve suspension, and anatomic (supracondylar/suprapatellar). The figure-8 harness is used for transhumeral (above-elbow) UPPER extremity prostheses, not transtibial.'),
  ]),

  'Prosthetics and Orthotics 4': const EpisodeQuiz(episodeTitle: 'Prosthetics and Orthotics 4', questions: [
    QuizQuestion(question: 'An ankle-foot orthosis (AFO) is primarily prescribed for:', options: ['Hip instability', 'Foot drop (weak ankle dorsiflexors) and ankle instability', 'Knee hyperextension only', 'Trunk support'], correctIndex: 1, explanation: 'AFOs are most commonly prescribed for foot drop (peroneal nerve palsy, L5 radiculopathy, stroke). They prevent the foot from dragging during swing phase and can also control ankle instability, manage spasticity-related equinus, and provide knee control through ground reaction forces.'),
    QuizQuestion(question: 'A solid ankle AFO provides:', options: ['Free ankle motion', 'Maximum ankle control with no dorsiflexion or plantarflexion', 'Only medial-lateral stability', 'Active ankle push-off'], correctIndex: 1, explanation: 'Solid ankle AFO: rigid at the ankle, blocks all ankle motion. Provides maximum stability and control. Used for significant spasticity, severe weakness, or when medial-lateral instability is present. Disadvantage: prevents normal ankle rocker mechanism, can cause knee hyperextension thrust if not properly trimmed.'),
    QuizQuestion(question: 'A hinged AFO (articulated AFO) differs from a solid AFO in that:', options: ['It is made of metal only', 'It allows controlled dorsiflexion while blocking plantarflexion (preventing foot drop)', 'It controls the hip joint', 'It is only for children'], correctIndex: 1, explanation: 'Hinged AFO: allows dorsiflexion (normal tibial advancement in stance) while a plantarflexion stop prevents foot drop in swing. This preserves more normal gait mechanics (third rocker). Best for patients with foot drop who have adequate medial-lateral ankle stability and can control dorsiflexion range.'),
    QuizQuestion(question: 'A knee-ankle-foot orthosis (KAFO) is indicated when:', options: ['Only ankle control is needed', 'Both knee and ankle control are needed (e.g., quadriceps weakness with foot drop)', 'Only for cosmetic purposes', 'For upper extremity support'], correctIndex: 1, explanation: 'KAFO: needed when knee instability (quadriceps weakness <3/5) exists in addition to ankle control needs. Common in polio, SCI, myelomeningocele. Adds significant weight and energy cost to ambulation. Knee lock options: drop-lock (manual), bail lock (spring-loaded), stance control (electronic — locks in stance, free in swing).'),
    QuizQuestion(question: 'Ground reaction AFO (floor reaction orthosis) is designed to:', options: ['Promote ankle plantarflexion', 'Create a knee extension moment to control crouch gait', 'Allow free ankle motion', 'Provide hip support'], correctIndex: 1, explanation: 'Ground reaction AFO: solid AFO with anterior tibial shell and rigid footplate. It positions the GRF vector ANTERIOR to the knee, creating a knee extension moment. Primary indication: crouch gait (excessive knee flexion in stance) in CP. It requires adequate ankle ROM to at least neutral for proper function.'),
  ]),

  'Prosthetics and Orthotics 5': const EpisodeQuiz(episodeTitle: 'Prosthetics and Orthotics 5', questions: [
    QuizQuestion(question: 'The most common upper extremity amputation level is:', options: ['Transhumeral', 'Transradial', 'Shoulder disarticulation', 'Wrist disarticulation'], correctIndex: 1, explanation: 'Transradial (below-elbow) is the most common upper extremity amputation level. Unlike lower extremity (mostly dysvascular), upper extremity amputations are predominantly trauma-related (young males in industrial/military settings). Preserving the elbow joint greatly improves prosthetic function.'),
    QuizQuestion(question: 'Body-powered upper extremity prostheses use which mechanism for terminal device control?', options: ['Myoelectric signals', 'A cable system activated by shoulder/scapular movement', 'Voice commands', 'Brain-computer interface'], correctIndex: 1, explanation: 'Body-powered prostheses: a cable system connects the terminal device to a harness (typically figure-8 design). Shoulder flexion/scapular abduction generates cable tension to open the terminal device (voluntary opening) or close it (voluntary closing). Advantages: durable, provides proprioceptive feedback through cable tension, lower cost, waterproof.'),
    QuizQuestion(question: 'Myoelectric prostheses detect:', options: ['Nerve impulses directly', 'EMG signals from residual limb muscles to control motorized components', 'Brain waves', 'Temperature changes'], correctIndex: 1, explanation: 'Myoelectric prostheses: surface electrodes in the socket detect EMG signals from residual muscles (e.g., wrist extensors = open, wrist flexors = close). A battery-powered motor actuates the terminal device. Advantages: cosmetically superior, no harness needed, stronger grip. Disadvantages: expensive, fragile, no proprioceptive feedback, moisture-sensitive.'),
    QuizQuestion(question: 'The terminal device in an upper extremity prosthesis can be:', options: ['Only a hook', 'A hook (split hook) or a prosthetic hand', 'Only a cosmetic hand', 'A powered elbow only'], correctIndex: 1, explanation: 'Terminal devices: voluntary-opening hook (most functional, best visual feedback of grip, most popular for work), voluntary-closing hook (grip force proportional to cable pull), or prosthetic hand (cosmetic, less functional grip). Many patients use a hook for work/function and switch to a cosmetic hand for social situations.'),
    QuizQuestion(question: 'Rejection rates for upper extremity prostheses are approximately:', options: ['5%', '20-30%', '50-75%', 'Nearly 100%'], correctIndex: 1, explanation: 'Upper extremity prosthetic rejection rates (~20-30%) are significantly higher than lower extremity. Reasons: limited proprioceptive feedback, weight, heat, difficulty with fine motor tasks, cosmetic concerns, and functional limitations compared to the intact hand. Early fitting (within 30 days) and intensive training improve acceptance.'),
  ]),

  'Prosthetics and Orthotics 6': const EpisodeQuiz(episodeTitle: 'Prosthetics and Orthotics 6', questions: [
    QuizQuestion(question: 'A cervical orthosis (Philadelphia collar) provides:', options: ['Full cervical immobilization', 'Moderate restriction of flexion/extension with limited rotational control', 'Only rotational control', 'No meaningful motion restriction'], correctIndex: 1, explanation: 'Philadelphia collar: semi-rigid, two-piece design (anterior + posterior). Restricts ~70% of flexion/extension but only ~30-50% of rotation and lateral bending. NOT adequate for unstable cervical fractures. For greater immobilization, a halo vest (restricts ~96% of motion) or SOMI brace is needed.'),
    QuizQuestion(question: 'A TLSO (thoracolumbosacral orthosis) controls motion primarily from:', options: ['C1 to the sacrum', 'T6 to the sacrum', 'The lumbar spine only', 'The cervical spine only'], correctIndex: 1, explanation: 'TLSO: controls motion from approximately T6 to the sacrum. It does not effectively control upper thoracic or cervical motion. For fractures above T6, a cervicothoracolumbosacral orthosis (CTLSO) or halo vest is needed. Common TLSOs include the Jewett hyperextension brace and custom-molded TLSOs.'),
    QuizQuestion(question: 'The Jewett hyperextension brace is designed to prevent:', options: ['Lateral bending', 'Flexion of the thoracolumbar spine', 'Extension of the cervical spine', 'Rotation of the lumbar spine'], correctIndex: 1, explanation: 'Jewett brace: three-point pressure system (sternal pad, suprapubic pad, posterior pad) that prevents flexion of the thoracolumbar spine. Used for stable compression fractures T6-L1. It does NOT control rotation or lateral bending. Contraindicated for burst fractures or posterior element injuries (which need circumferential control).'),
    QuizQuestion(question: 'A Boston brace is used to treat:', options: ['Cervical fractures', 'Adolescent idiopathic scoliosis', 'Ankle instability', 'Carpal tunnel syndrome'], correctIndex: 1, explanation: 'Boston brace: underarm TLSO used for adolescent idiopathic scoliosis. It applies corrective forces through pads placed over the convexity of the curve. Indications: curves 25-40° in skeletally immature patients (Risser 0-2). Worn 18-23 hours/day. Goal: prevent progression, not correct the curve. Surgery indicated for curves >40-50°.'),
    QuizQuestion(question: 'Halo vest orthosis provides the MOST cervical spine immobilization and is indicated for:', options: ['Minor cervical sprains', 'Unstable cervical fractures (e.g., C2 fractures, burst fractures)', 'Lumbar disc herniations', 'Thoracic scoliosis'], correctIndex: 1, explanation: 'Halo vest: gold standard for cervical immobilization (~96% restriction of all motions). Four skull pins attach the halo ring; vest provides counterforce. Indications: unstable C-spine fractures (odontoid type II, hangman, unstable burst fractures), post-surgical stabilization. Complications: pin loosening, infection, pin-site ring sequestrum, restricted pulmonary function.'),
  ]),

  'Prosthetics and Orthotics 7': const EpisodeQuiz(episodeTitle: 'Prosthetics and Orthotics 7', questions: [
    QuizQuestion(question: 'A wrist-hand orthosis (WHO) in the resting hand position maintains:', options: ['Wrist in maximum flexion', 'Wrist 20-30° extension, MCPs 45-70° flexion, IPs slight flexion, thumb opposed', 'All joints in full extension', 'Only the thumb in opposition'], correctIndex: 1, explanation: 'Resting hand splint (WHO): maintains the functional position — wrist 20-30° extension, MCPs 45-70° flexion, IP joints slightly flexed, thumb in palmar abduction and opposition. This prevents shortening of collateral ligaments and joint contractures. Used for upper motor neuron injuries (stroke, TBI), burns, and inflammatory conditions.'),
    QuizQuestion(question: 'A tenodesis splint (wrist-driven flexor hinge orthosis) is designed for patients with:', options: ['Complete hand paralysis', 'C6 tetraplegia — uses wrist extension to passively flex the fingers for grasp', 'Carpal tunnel syndrome', 'Trigger finger'], correctIndex: 1, explanation: 'Tenodesis splint: mechanical linkage that converts active wrist extension (C6 — ECRL intact) into passive finger flexion (grasp) and wrist flexion into finger extension (release). This provides functional prehension for C6 tetraplegics who lack hand intrinsics. The mechanical principle mimics the natural tenodesis effect.'),
    QuizQuestion(question: 'An opponent splint (short opponens) is used to:', options: ['Immobilize the wrist', 'Maintain the thumb in opposition to preserve the first web space', 'Control finger flexion', 'Stabilize the elbow'], correctIndex: 1, explanation: 'Short opponens splint: maintains thumb CMC joint in palmar abduction and opposition, preserving the first web space. Used for median nerve palsy (loss of thenar muscles), thumb CMC arthritis, and after tendon transfer. It positions the thumb for functional pinch without immobilizing the wrist or fingers.'),
    QuizQuestion(question: 'Dynamic splinting differs from static splinting in that:', options: ['Dynamic is always more comfortable', 'Dynamic applies a low-load prolonged stretch through springs, rubber bands, or elastic components', 'Static is never used in rehabilitation', 'Dynamic is only for the lower extremity'], correctIndex: 1, explanation: 'Dynamic splints: apply continuous low-load force through elastic components (springs, rubber bands, outriggers) to gradually increase ROM. Best for joint stiffness with tissue remodeling potential. Static splints: rigid, maintain a fixed position (protect, immobilize, or prevent contracture). Serial static splinting: progressive position changes as ROM improves.'),
    QuizQuestion(question: 'In a C5 tetraplegic, a mobile arm support (balanced forearm orthosis) assists with:', options: ['Walking', 'Overhead reaching', 'Table-top self-feeding by supporting the arm against gravity', 'Trunk balance'], correctIndex: 2, explanation: 'Mobile arm support (MAS/balanced forearm orthosis): gravity-eliminated arm support mounted to the wheelchair. Allows C5 tetraplegics (intact deltoid and biceps but no triceps/hand function) to perform tabletop activities (feeding with adapted utensils, page turning) by eliminating gravity from the movement. Arm floats on a trough balanced on a pivot.'),
  ]),

  'Prosthetics and Orthotics 8': const EpisodeQuiz(episodeTitle: 'Prosthetics and Orthotics 8', questions: [
    QuizQuestion(question: 'Chopart (midtarsal) amputation preserves:', options: ['No foot structure', 'The calcaneus and talus (hindfoot)', 'The metatarsals', 'Only the great toe'], correctIndex: 1, explanation: 'Chopart amputation: disarticulation through the talonavicular and calcaneocuboid joints, preserving the hindfoot (talus and calcaneus). Risk: equinus/varus deformity from unopposed tibialis posterior and Achilles. Requires Achilles tendon lengthening and custom shoe filler/AFO. Can be end-bearing.'),
    QuizQuestion(question: 'A Syme amputation (ankle disarticulation) has which advantage?', options: ['Normal ankle ROM is preserved', 'The heel pad is preserved for end-bearing, allowing limited ambulation without a prosthesis', 'It is purely cosmetic', 'No prosthetic is ever needed'], correctIndex: 1, explanation: 'Syme amputation: ankle disarticulation with preserved heel pad secured over the distal tibia. Advantages: end-bearing capability (can ambulate short distances without prosthesis), durable weight-bearing surface, longer lever arm than transtibial. Disadvantage: bulbous distal end is cosmetically challenging for prosthetic design.'),
    QuizQuestion(question: 'The energy expenditure hierarchy for amputation level from LOWEST to HIGHEST is:', options: ['Transfemoral → Transtibial → Syme', 'Syme → Transtibial → Transfemoral', 'Transtibial → Syme → Transfemoral', 'All levels have equal energy cost'], correctIndex: 1, explanation: 'Energy cost increases with higher amputation level: Syme (lowest increase) → Transtibial (10-25%) → Knee disarticulation → Transfemoral (40-65%) → Hip disarticulation (highest). Preserving every joint, especially the knee, dramatically reduces energy expenditure. This is why limb salvage and distal amputation are preferred.'),
    QuizQuestion(question: 'An ischial containment socket (narrow ML design) for transfemoral prostheses:', options: ['Loads weight on the ischial tuberosity on a shelf', 'Contains the ischium WITHIN the socket for better medial-lateral control', 'Is only for pediatric patients', 'Does not provide suction'], correctIndex: 1, explanation: 'Ischial containment (IC/IRC) socket: the ischial tuberosity and ramus are contained WITHIN the socket (vs. older quadrilateral socket where ischium sits ON a posterior shelf). Benefits: better mediolateral control, improved femoral alignment, better muscle function, more comfortable. It is the current standard for transfemoral prosthetics.'),
    QuizQuestion(question: 'Preprosthetic management after amputation includes all EXCEPT:', options: ['Edema control (elastic wrapping, shrinker sock)', 'Desensitization of the residual limb', 'Contracture prevention (ROM exercises, positioning)', 'Immediate return to unrestricted activity'], correctIndex: 3, explanation: 'Preprosthetic management: edema control (figure-8 wrapping, shrinker socks), desensitization (tapping, massage), contracture prevention (ROM, positioning — avoid pillow under knee), cardiovascular conditioning, upper body strengthening, and emotional support. Activity is progressed gradually with prosthetic fitting when the limb is mature and edema-free.'),
  ]),

  'Prosthetics and Orthotics 9': const EpisodeQuiz(episodeTitle: 'Prosthetics and Orthotics 9', questions: [
    QuizQuestion(question: 'Energy-storing prosthetic feet (dynamic response feet) are best for:', options: ['Sedentary K0-K1 ambulators', 'Active K3-K4 ambulators who need energy return for walking and running', 'Non-ambulatory patients', 'Patients who refuse therapy'], correctIndex: 1, explanation: 'Energy-storing feet (Flex-Foot, Carbon fiber designs): the keel deforms during stance (storing energy) and recoils during push-off (returning energy). This reduces metabolic cost and enables higher activity levels. Best for K3-K4 ambulators. The carbon fiber leaf spring design revolutionized prosthetic feet for active amputees.'),
    QuizQuestion(question: 'Vacuum-assisted suspension (elevated vacuum) in prosthetics provides:', options: ['Loose socket fit', 'Active negative pressure between the liner and socket wall, reducing pistoning and improving proprioception', 'Only cosmetic benefit', 'The same effect as a supracondylar strap'], correctIndex: 1, explanation: 'Elevated vacuum (e-vac): a pump maintains active negative pressure in the space between liner and socket. Benefits: eliminates pistoning, reduces volume fluctuation, improves proprioception, better residual limb health (prevents edema and skin breakdown). Considered the most advanced suspension for transtibial prosthetics.'),
    QuizQuestion(question: 'In prosthetic gait analysis, vaulting (rising on the sound-side toes) suggests:', options: ['Good prosthetic fit', 'The prosthesis is too long or has inadequate knee flexion in swing', 'The prosthesis is too short', 'Normal gait compensation'], correctIndex: 1, explanation: 'Vaulting: the patient rises onto the toes of the sound limb during swing phase of the prosthetic side. Causes: prosthesis too long, inadequate knee flexion during swing (excessive friction, inadequate suspension), or fear of stumbling. Other swing-phase deviations: circumduction and lateral trunk lean also suggest length or clearance issues.'),
    QuizQuestion(question: 'Socket fit issues causing distal end pain in a transtibial prosthesis most likely indicate:', options: ['Socket is too tight proximally', 'Socket is too loose — the limb is pistoning and bottoming out', 'The foot is too stiff', 'The alignment is perfect'], correctIndex: 1, explanation: 'Distal end pain: usually from the residual limb settling too deeply into a loose socket (bottoming out/pistoning). The distal tibia impacts the socket bottom. Solutions: add socks to restore fit, re-evaluate suspension, consider socket replacement if volume loss is significant. Poor suspension allows pistoning that causes this problem.'),
    QuizQuestion(question: 'Targeted muscle reinnervation (TMR) in upper extremity amputees improves:', options: ['Bone healing', 'Myoelectric prosthesis control by providing additional EMG signal sites', 'Passive ROM', 'Cosmetic appearance only'], correctIndex: 1, explanation: 'TMR: residual nerves are surgically transferred to denervated chest or upper arm muscles. These muscles then serve as biological amplifiers of motor intent — the patient "thinks" about hand open/close, and the reinnervated muscles produce distinct EMG signals for intuitive myoelectric prosthetic control. Also reduces neuroma pain.'),
  ]),

  'Prosthetics and Orthotics 10': const EpisodeQuiz(episodeTitle: 'Prosthetics and Orthotics 10', questions: [
    QuizQuestion(question: 'Osseointegration in prosthetics involves:', options: ['A socket-based attachment system', 'A titanium implant directly fixed to the bone, with an abutment percutaneously connecting to the prosthesis', 'A suction suspension method', 'An elastic sleeve'], correctIndex: 1, explanation: 'Osseointegration: a titanium fixture is surgically implanted into the residual bone (femur or humerus). After integration, a percutaneous abutment connects to the external prosthesis. Benefits: eliminates socket-related problems, improved proprioception (osseoperception), better ROM. Risks: infection at skin-implant interface, periprosthetic fracture.'),
    QuizQuestion(question: 'The appropriate volume management tool for a newly amputated residual limb that is ready for prosthetic fitting is:', options: ['No wrapping needed', 'A shrinker sock or elastic bandage in a figure-8 pattern', 'A rigid cast', 'Hot packs to increase circulation'], correctIndex: 1, explanation: 'Shrinker socks (elastic compressive garments) or figure-8 elastic bandage wrapping: applied to mature the residual limb (reduce edema, shape for socket fitting). Figure-8 wrapping should be distal-to-proximal with more pressure distally. The limb must be edema-free and conically shaped before definitive prosthetic casting.'),
    QuizQuestion(question: 'A stance-control KAFO differs from a locked KAFO in that:', options: ['It is heavier', 'It allows free knee flexion during swing phase while locking in stance for stability', 'It does not control the knee at all', 'It only works with a specific shoe'], correctIndex: 1, explanation: 'Stance-control KAFO (SCKAFO): electronic or mechanical system locks the knee during stance (preventing buckling) but allows free knee motion during swing (more natural gait). Advantages over locked KAFO: more normal gait pattern, reduced energy cost, improved cosmesis. Requires adequate hip flexor strength and proprioception to trigger the unlock.'),
    QuizQuestion(question: 'The most critical factor in determining prosthetic candidacy for a dysvascular amputee is:', options: ['Age alone', 'Overall cardiovascular reserve and cognitive ability to learn prosthetic use', 'Insurance status', 'The cause of amputation'], correctIndex: 1, explanation: 'Prosthetic candidacy depends on: cardiovascular reserve (can the patient meet the energy demands?), cognitive function (can they learn safe prosthetic use?), motivation, wound healing status, vision, upper extremity strength for transfers, and social support. Age alone is NOT a contraindication. Many elderly dysvascular amputees succeed with appropriate prosthetic prescription.'),
    QuizQuestion(question: 'Skin problems are the most common prosthetic complication. Which is NOT a typical cause?', options: ['Socket friction and shear', 'Allergic contact dermatitis to liner materials', 'Poor socket hygiene', 'Wearing the prosthesis for too few hours per day'], correctIndex: 3, explanation: 'Common prosthetic skin issues: friction/shear (mechanical), allergic contact dermatitis (liner materials), folliculitis (hair follicle infection from friction/moisture), verrucous hyperplasia (from distal suction in a poorly fitting socket), and excessive sweating. Wearing TOO MUCH (not too little) causes most skin problems. Daily socket and liner hygiene is essential.'),
  ]),

  // ── Wheelchair 1-2 ──
  'Wheelchair and Seating 1': const EpisodeQuiz(episodeTitle: 'Wheelchair and Seating 1', questions: [
  ...
  'Wheelchair and Seating 2': const EpisodeQuiz(episodeTitle: 'Wheelchair and Seating 2', questions: [
  ...
  // ── Pulmonary Rehab 1-3 ──
  'Pulmonary Rehabilitation 1': const EpisodeQuiz(episodeTitle: 'Pulmonary Rehabilitation 1', questions: [
    QuizQuestion(question: 'The primary muscle of respiration is:', options: ['Internal intercostals', 'External intercostals', 'Diaphragm', 'Sternocleidomastoid'], correctIndex: 2, explanation: 'The diaphragm (innervated by the phrenic nerve, C3-C5) is responsible for ~70% of quiet breathing. When it contracts, it descends, creating negative intrathoracic pressure. Accessory muscles (SCM, scalenes, external intercostals) assist during exercise or respiratory distress.'),
    QuizQuestion(question: 'Obstructive lung disease (COPD) is characterized by:', options: ['Reduced total lung capacity', 'Increased residual volume, decreased FEV1/FVC ratio, air trapping', 'Normal spirometry', 'Restrictive pattern on PFTs'], correctIndex: 1, explanation: 'Obstructive disease (COPD, asthma, emphysema): airflow limitation during expiration. FEV1/FVC ratio <70% (hallmark). Air trapping increases residual volume and total lung capacity. The FEV1 is reduced disproportionately to FVC. Restrictive disease shows reduced TLC with preserved or increased FEV1/FVC ratio.'),
    QuizQuestion(question: 'Pursed-lip breathing in COPD patients helps by:', options: ['Increasing oxygen intake', 'Creating back-pressure that stents open collapsed airways and prolongs expiration', 'Strengthening the diaphragm', 'Reducing heart rate'], correctIndex: 1, explanation: 'Pursed-lip breathing: expiring against partially closed lips creates positive back-pressure in the airways, preventing premature small airway collapse (which causes air trapping in emphysema). This prolongs expiration, improves CO2 elimination, reduces respiratory rate, and decreases dyspnea. One of the most effective self-management strategies.'),
    QuizQuestion(question: 'The 6-minute walk test (6MWT) measures:', options: ['Maximum sprint speed', 'Submaximal functional exercise capacity (distance walked in 6 minutes)', 'Lung volumes', 'Maximum oxygen consumption'], correctIndex: 1, explanation: '6MWT: practical, reliable measure of functional exercise capacity. The patient walks as far as possible in 6 minutes on a flat surface. Normal: ~400-700m depending on age/sex. A minimal clinically important difference (MCID) is ~30 meters. It correlates with VO2max, predicts mortality in COPD, and is used to monitor pulmonary rehab outcomes.'),
    QuizQuestion(question: 'Supplemental oxygen is indicated for COPD patients with resting PaO2:', options: ['<80 mmHg', '<55 mmHg (or <60 mmHg with cor pulmonale/polycythemia)', '>90 mmHg', '<70 mmHg'], correctIndex: 1, explanation: 'Long-term oxygen therapy (LTOT) criteria: PaO2 ≤55 mmHg or SaO2 ≤88% at rest, OR PaO2 56-59 mmHg with evidence of cor pulmonale, right heart failure, or polycythemia (Hct >55%). LTOT ≥15 hours/day has been shown to improve survival. Target SpO2 88-92% (avoid hyperoxia which can suppress respiratory drive).'),
  ]),

  'Pulmonary Rehabilitation 2': const EpisodeQuiz(episodeTitle: 'Pulmonary Rehabilitation 2', questions: [
    QuizQuestion(question: 'Pulmonary rehabilitation has been shown to improve all EXCEPT:', options: ['Exercise tolerance', 'Quality of life and dyspnea', 'FEV1 (airway obstruction)', 'Depression and anxiety'], correctIndex: 2, explanation: 'Pulmonary rehab improves exercise capacity, dyspnea, quality of life, reduces hospitalizations, and improves anxiety/depression. However, it does NOT improve FEV1 or reverse airway obstruction. The benefits come from improved muscle conditioning, breathing techniques, and self-management education — not from reversing the underlying disease.'),
    QuizQuestion(question: 'Incentive spirometry primarily helps:', options: ['Strengthen expiratory muscles', 'Encourage deep sustained inspiration to prevent atelectasis', 'Measure peak expiratory flow', 'Diagnose COPD'], correctIndex: 1, explanation: 'Incentive spirometry: visual feedback device that encourages sustained maximal inspiration (slow deep breaths). This expands alveoli, prevents/treats atelectasis (collapsed lung segments), and improves mucociliary clearance. Used post-operatively and in patients with restricted breathing patterns. Goal: 10 repetitions every 1-2 hours while awake.'),
    QuizQuestion(question: 'Diaphragmatic breathing exercises train the patient to:', options: ['Breathe using accessory muscles', 'Maximize diaphragmatic excursion while minimizing chest wall and accessory muscle use', 'Hold their breath for extended periods', 'Breathe as rapidly as possible'], correctIndex: 1, explanation: 'Diaphragmatic breathing: patient places hand on abdomen, inhales through nose letting abdomen rise (diaphragm descending), then exhales slowly through pursed lips as abdomen falls. This retrains the breathing pattern from inefficient upper chest breathing to efficient diaphragmatic breathing. Reduces work of breathing and dyspnea.'),
    QuizQuestion(question: 'Chest percussion and postural drainage are used to:', options: ['Strengthen the diaphragm', 'Mobilize and clear retained pulmonary secretions from specific lung segments', 'Improve vocal cord function', 'Treat pneumothorax'], correctIndex: 1, explanation: 'Chest physiotherapy (percussion + postural drainage): positions the patient so gravity assists drainage from specific lung segments while rhythmic percussion loosens adherent secretions. Used in cystic fibrosis, bronchiectasis, and patients with thick secretions. Each lung segment has a specific drainage position based on bronchial anatomy.'),
    QuizQuestion(question: 'The Borg RPE (Rating of Perceived Exertion) scale used in pulmonary rehab ranges from:', options: ['0 to 5', '6 to 20', '1 to 100', '0 to 4'], correctIndex: 1, explanation: 'Borg RPE scale: 6 (no exertion) to 20 (maximal exertion). Target for pulmonary rehab exercise: 12-14 (somewhat hard). The modified Borg dyspnea scale (0-10) is also commonly used specifically for breathlessness. RPE is especially useful when heart rate response is unreliable (beta-blockers, deconditioning, pacemaker).'),
  ]),

  'Pulmonary Rehabilitation 3': const EpisodeQuiz(episodeTitle: 'Pulmonary Rehabilitation 3', questions: [
    QuizQuestion(question: 'Restrictive lung disease is characterized by:', options: ['FEV1/FVC ratio <70%', 'Reduced total lung capacity with normal or increased FEV1/FVC ratio', 'Air trapping', 'Wheezing on examination'], correctIndex: 1, explanation: 'Restrictive disease: reduced TLC (lungs cannot fully expand). FEV1 and FVC both reduced proportionally, so FEV1/FVC ratio is preserved or increased (>70%). Causes: interstitial lung disease, chest wall deformity (kyphoscoliosis), neuromuscular disease (SCI, ALS, muscular dystrophy), obesity. Distinguished from obstructive disease by preserved ratio.'),
    QuizQuestion(question: 'Oxygen toxicity can occur with prolonged FiO2 above:', options: ['21%', '40%', '60%', '100% only'], correctIndex: 2, explanation: 'Prolonged FiO2 >60% risks oxygen toxicity: alveolar damage, inflammation, atelectasis (absorption atelectasis from nitrogen washout), and eventually ARDS. In COPD patients, even moderate supplemental O2 can suppress hypoxic ventilatory drive. Target SpO2 88-92% in COPD. Higher FiO2 is acceptable short-term in acute respiratory failure.'),
    QuizQuestion(question: 'Sleep-disordered breathing (obstructive sleep apnea) is treated primarily with:', options: ['Supplemental oxygen alone', 'Continuous positive airway pressure (CPAP)', 'Bronchodilators', 'Chest physiotherapy'], correctIndex: 1, explanation: 'CPAP: gold standard for OSA. Delivers continuous positive pressure through a mask, splinting the upper airway open and preventing pharyngeal collapse during sleep. Reduces apneic events, improves daytime sleepiness, reduces cardiovascular risk. BiPAP (bilevel) is used for patients who cannot tolerate CPAP or have hypoventilation syndromes.'),
    QuizQuestion(question: 'Ventilator weaning in rehabilitation involves:', options: ['Abruptly discontinuing mechanical ventilation', 'Progressive reduction of ventilator support with gradual increases in spontaneous breathing trials', 'Permanent ventilator dependence', 'Only using CPAP'], correctIndex: 1, explanation: 'Ventilator weaning: progressive reduction of support through spontaneous breathing trials (SBT), pressure support reduction, or T-piece trials. Parameters for readiness: adequate oxygenation (PaO2/FiO2 >200), intact respiratory drive, manageable secretions, hemodynamic stability. Success markers: rapid shallow breathing index (RR/TV) <105, negative inspiratory force >-20 cmH2O.'),
    QuizQuestion(question: 'Respiratory failure is classified as Type I or Type II. Type II is defined by:', options: ['Hypoxemia alone (PaO2 <60)', 'Hypoxemia WITH hypercapnia (PaO2 <60, PaCO2 >50)', 'Normal blood gases', 'Only elevated CO2'], correctIndex: 1, explanation: 'Type I (hypoxemic): PaO2 <60 mmHg with normal/low PaCO2 (V/Q mismatch, shunt). Type II (hypercapnic/ventilatory): PaO2 <60 WITH PaCO2 >50 mmHg (pump failure — the patient cannot ventilate adequately). Causes of Type II: COPD, neuromuscular disease, chest wall deformity, CNS depression. Treatment: address both oxygenation AND ventilation.'),
  ]),

  // ── Pain 1-4 ──
  'Pain Management 1': const EpisodeQuiz(episodeTitle: 'Pain Management 1', questions: [
    QuizQuestion(question: 'Nociceptive pain differs from neuropathic pain in that nociceptive pain:', options: ['Is always chronic', 'Results from activation of peripheral nociceptors by tissue damage (somatic or visceral)', 'Is caused by nerve damage and described as burning/shooting', 'Does not respond to NSAIDs'], correctIndex: 1, explanation: 'Nociceptive: normal neural processing of noxious stimuli from tissue damage. Somatic (musculoskeletal — well-localized, aching) or visceral (organ — diffuse, cramping, referred). Neuropathic: caused by damage/dysfunction of the nervous system itself (burning, shooting, electric, allodynia). Treatment differs: nociceptive responds to NSAIDs/opioids; neuropathic to anticonvulsants/antidepressants.'),
    QuizQuestion(question: 'The WHO analgesic ladder Step 1 (mild pain) recommends:', options: ['Strong opioids', 'Acetaminophen and/or NSAIDs ± adjuvants', 'Nerve blocks', 'Intrathecal pump'], correctIndex: 1, explanation: 'WHO ladder: Step 1 (mild, 1-3/10): non-opioid analgesics (acetaminophen, NSAIDs) ± adjuvants. Step 2 (moderate, 4-6/10): weak opioids (tramadol, codeine) + non-opioids. Step 3 (severe, 7-10/10): strong opioids (morphine, hydromorphone, fentanyl) + non-opioids ± adjuvants. The ladder emphasizes multimodal analgesia.'),
    QuizQuestion(question: 'Gabapentin and pregabalin treat neuropathic pain by:', options: ['Blocking opioid receptors', 'Binding to alpha-2-delta subunit of voltage-gated calcium channels, reducing excitatory neurotransmitter release', 'Inhibiting COX enzymes', 'Blocking sodium channels'], correctIndex: 1, explanation: 'Gabapentinoids bind the alpha-2-delta subunit of voltage-gated calcium channels, reducing calcium influx and thereby decreasing release of excitatory neurotransmitters (glutamate, substance P). First-line for neuropathic pain (diabetic neuropathy, postherpetic neuralgia, central pain). Pregabalin has more predictable pharmacokinetics than gabapentin.'),
    QuizQuestion(question: 'The ceiling effect of acetaminophen means:', options: ['It works better at higher doses', 'Beyond 4g/day there is no additional analgesic benefit but hepatotoxicity risk increases dramatically', 'It has no side effects', 'It can be combined with any other drug safely'], correctIndex: 1, explanation: 'Acetaminophen: analgesic ceiling at 3-4g/day for adults (2g/day for hepatic impairment or chronic alcohol use). Beyond this dose, no additional pain relief but significant risk of hepatotoxicity (leading cause of acute liver failure in the US). It has NO anti-inflammatory effect (unlike NSAIDs). Always check for acetaminophen in combination products.'),
    QuizQuestion(question: 'Central sensitization in chronic pain is characterized by:', options: ['Decreased spinal cord excitability', 'Amplified CNS processing causing allodynia (pain from non-painful stimuli) and hyperalgesia', 'Normal pain processing', 'Only peripheral nerve changes'], correctIndex: 1, explanation: 'Central sensitization: increased excitability of CNS neurons causing: allodynia (pain from normally innocuous stimuli), hyperalgesia (exaggerated pain response), temporal summation (wind-up), and expanded receptive fields. This is a key mechanism in chronic pain conditions (fibromyalgia, chronic low back pain, complex regional pain syndrome).'),
  ]),

  'Pain Management 2': const EpisodeQuiz(episodeTitle: 'Pain Management 2', questions: [
    QuizQuestion(question: 'Opioid equianalgesic dosing is based on comparison to which standard?', options: ['Acetaminophen', 'Morphine 10 mg IV', 'Fentanyl 100 mcg', 'Hydrocodone 5 mg'], correctIndex: 1, explanation: 'Morphine 10 mg IV (or 30 mg PO) is the standard reference for equianalgesic dosing. Key conversions: hydromorphone ~1.5 mg IV = morphine 10 mg IV, oxycodone 20 mg PO = morphine 30 mg PO, fentanyl 100 mcg IV ≈ morphine 10 mg IV. Always reduce the calculated equianalgesic dose by 25-50% when rotating opioids (incomplete cross-tolerance).'),
    QuizQuestion(question: 'Trigger point injections target:', options: ['Nerve roots', 'Taut bands of skeletal muscle with palpable nodules that produce referred pain patterns', 'Joint capsules', 'Bone lesions'], correctIndex: 1, explanation: 'Myofascial trigger points: hyperirritable spots within taut bands of skeletal muscle that produce local and referred pain when compressed. Treatment: direct needling (dry needling) or injection of local anesthetic ± corticosteroid into the trigger point. Post-injection stretching is essential. Common in tension headache, low back pain, and neck pain.'),
    QuizQuestion(question: 'Complex regional pain syndrome (CRPS) Type I diagnostic criteria (Budapest) require:', options: ['Only pain', 'Pain disproportionate to the inciting event PLUS signs/symptoms in multiple categories (sensory, vasomotor, sudomotor, motor/trophic)', 'Positive X-ray findings', 'EMG abnormalities'], correctIndex: 1, explanation: 'Budapest criteria for CRPS-I: (1) Continuing pain disproportionate to any inciting event, (2) At least one symptom in 3 of 4 categories (sensory, vasomotor, sudomotor/edema, motor/trophic), (3) At least one sign in 2 or more categories, (4) No other diagnosis better explains the findings. CRPS-II requires a definable nerve injury.'),
    QuizQuestion(question: 'The most common side effect of chronic opioid use that does NOT develop tolerance is:', options: ['Nausea', 'Sedation', 'Constipation', 'Respiratory depression'], correctIndex: 2, explanation: 'Constipation: the ONE opioid side effect that does NOT develop tolerance. Patients on chronic opioids need a bowel regimen for the duration of therapy. Tolerance develops to nausea, sedation, and respiratory depression. Constipation management: stimulant laxative (senna) + stool softener (docusate), or methylnaltrexone for refractory opioid-induced constipation.'),
    QuizQuestion(question: 'A medial branch block is a diagnostic tool for:', options: ['Disc herniation', 'Facet joint-mediated pain', 'Sacroiliac joint pain', 'Myofascial pain'], correctIndex: 1, explanation: 'Medial branch blocks: local anesthetic injected onto the medial branch nerves that innervate the facet (zygapophyseal) joints. Each facet is innervated by 2 medial branches (one from the level above and one at the same level). If ≥80% pain relief occurs on two separate occasions, the patient is a candidate for radiofrequency ablation of those medial branches.'),
  ]),

  'Pain Management 3': const EpisodeQuiz(episodeTitle: 'Pain Management 3', questions: [
    QuizQuestion(question: 'Fibromyalgia is characterized by:', options: ['Joint inflammation visible on imaging', 'Widespread musculoskeletal pain, fatigue, sleep disturbance, and cognitive difficulties without structural pathology', 'Elevated inflammatory markers', 'Positive autoimmune antibodies'], correctIndex: 1, explanation: 'Fibromyalgia: central sensitization syndrome with widespread pain (≥3 months), fatigue, non-restorative sleep, and cognitive dysfunction ("fibro fog"). Labs and imaging are NORMAL. 2010/2016 ACR criteria replaced tender points with widespread pain index and symptom severity scale. Treatment: exercise (strongest evidence), duloxetine, pregabalin, milnacipran, CBT.'),
    QuizQuestion(question: 'Duloxetine (Cymbalta) treats pain in fibromyalgia through:', options: ['Opioid receptor activation', 'Serotonin-norepinephrine reuptake inhibition (SNRI) enhancing descending inhibitory pain pathways', 'COX inhibition', 'Muscle relaxation'], correctIndex: 1, explanation: 'Duloxetine (SNRI): inhibits reuptake of both serotonin and norepinephrine, strengthening descending inhibitory pain pathways from the brainstem. FDA-approved for fibromyalgia, diabetic peripheral neuropathy, and chronic musculoskeletal pain. Also treats comorbid depression/anxiety. Three FDA-approved drugs for fibromyalgia: duloxetine, milnacipran, pregabalin.'),
    QuizQuestion(question: 'Spinal cord stimulation (SCS) is indicated for:', options: ['Acute postoperative pain', 'Chronic neuropathic pain (failed back surgery syndrome, CRPS) refractory to conservative treatment', 'All types of headache', 'Acute disc herniation'], correctIndex: 1, explanation: 'SCS: electrodes placed in the epidural space deliver electrical impulses that modulate pain signals (gate control theory). Primary indications: failed back surgery syndrome (most common), CRPS, peripheral neuropathy. A trial period (1 week) must demonstrate ≥50% pain reduction before permanent implant. Does not work for nociceptive pain.'),
    QuizQuestion(question: 'Myofascial pain syndrome differs from fibromyalgia in that myofascial pain:', options: ['Is always generalized', 'Is regional with specific trigger points that reproduce the pain pattern', 'Has elevated CRP', 'Requires surgery'], correctIndex: 1, explanation: 'Myofascial pain: REGIONAL pain with identifiable trigger points in taut bands that reproduce the specific pain pattern on palpation. Fibromyalgia: WIDESPREAD pain without specific trigger points, associated with central sensitization. They can coexist. Myofascial pain responds well to trigger point treatment; fibromyalgia requires a multimodal central-acting approach.'),
    QuizQuestion(question: 'Opioid use disorder (OUD) risk factors include all EXCEPT:', options: ['Personal history of substance abuse', 'Family history of addiction', 'Younger age', 'Taking opioids for 3 days after surgery'], correctIndex: 3, explanation: 'OUD risk factors: personal/family history of substance abuse, psychiatric comorbidity (depression, PTSD, anxiety), younger age, history of childhood trauma, and social factors. Short-term opioid use (<7 days for acute pain) has low addiction risk. Chronic opioid therapy (>90 days), high daily doses (>50 MME), and concurrent benzodiazepines increase risk substantially.'),
  ]),

  'Pain Management 4': const EpisodeQuiz(episodeTitle: 'Pain Management 4', questions: [
    QuizQuestion(question: 'Epidural steroid injections deliver medication to:', options: ['The intrathecal space', 'The epidural space (between the ligamentum flavum and dura mater)', 'The facet joint', 'The muscle'], correctIndex: 1, explanation: 'ESI: corticosteroid ± local anesthetic injected into the epidural space to reduce inflammation around compressed nerve roots. Approaches: interlaminar (midline), transforaminal (targeted to specific nerve root — most specific), and caudal (through sacral hiatus). Most effective for acute/subacute radicular pain with imaging-confirmed pathology.'),
    QuizQuestion(question: 'A stellate ganglion block is used to diagnose and treat:', options: ['Low back pain', 'Sympathetically maintained pain of the upper extremity (CRPS)', 'Knee arthritis', 'Headaches only'], correctIndex: 1, explanation: 'Stellate ganglion block: local anesthetic injected at the C6 or C7 transverse process targeting the cervicothoracic sympathetic ganglion. Diagnostic: if pain resolves, it confirms sympathetically maintained pain. Therapeutic: can provide lasting relief in CRPS of the upper extremity. Signs of successful block: ipsilateral Horner syndrome (ptosis, miosis, anhidrosis).'),
    QuizQuestion(question: 'Intrathecal drug delivery systems (pain pumps) deliver medication to:', options: ['The epidural space', 'The cerebrospinal fluid directly, requiring 1/300th of the oral dose', 'The bloodstream', 'The muscle'], correctIndex: 1, explanation: 'Intrathecal pump: delivers medication directly to the CSF, bypassing the blood-brain barrier. Morphine or ziconotide (non-opioid, N-type calcium channel blocker) are FDA-approved. Requires ~1/300th of the oral morphine dose, dramatically reducing systemic side effects. Indicated for refractory cancer pain or chronic non-cancer pain failing other treatments.'),
    QuizQuestion(question: 'Nonsteroidal anti-inflammatory drugs (NSAIDs) work by:', options: ['Blocking opioid receptors', 'Inhibiting cyclooxygenase (COX) enzymes, reducing prostaglandin synthesis', 'Enhancing serotonin levels', 'Blocking calcium channels'], correctIndex: 1, explanation: 'NSAIDs inhibit COX enzymes: COX-1 (constitutive — protects gastric mucosa, supports platelet function, maintains renal blood flow) and COX-2 (inducible — mediates inflammation and pain). Non-selective NSAIDs (ibuprofen, naproxen) inhibit both. COX-2 selective (celecoxib) has less GI toxicity but carries cardiovascular risk. All NSAIDs have renal and GI risks.'),
    QuizQuestion(question: 'The biopsychosocial model of chronic pain emphasizes:', options: ['Pain is purely a physical phenomenon', 'Pain results from the interaction of biological, psychological, and social factors', 'Only psychological factors matter', 'Surgery is always needed for chronic pain'], correctIndex: 1, explanation: 'Biopsychosocial model: chronic pain involves biological (tissue damage, central sensitization), psychological (depression, catastrophizing, fear-avoidance), and social (disability, family dynamics, work status) factors. Treatment must address all three domains — interdisciplinary pain programs using medical management, CBT, physical therapy, and vocational counseling have the strongest evidence.'),
  ]),

  // ── Rheumatology 1-6 ──
  'Rheumatology 1': const EpisodeQuiz(episodeTitle: 'Rheumatology 1', questions: [
    QuizQuestion(question: 'Rheumatoid arthritis primarily affects which joints?', options: ['Large weight-bearing joints only', 'Small joints of the hands and feet symmetrically (MCPs, PIPs, wrists)', 'The spine exclusively', 'DIP joints only'], correctIndex: 1, explanation: 'RA: symmetric inflammatory polyarthritis primarily affecting MCPs, PIPs, and wrists. DIPs are typically SPARED (DIP involvement suggests osteoarthritis or psoriatic arthritis). Morning stiffness >1 hour is characteristic. RF and anti-CCP antibodies are diagnostic markers. Treatment: early DMARDs (methotrexate first-line).'),
    QuizQuestion(question: 'Swan neck deformity in RA consists of:', options: ['DIP hyperextension and PIP flexion', 'PIP hyperextension and DIP flexion', 'MCP ulnar deviation only', 'Thumb Z-deformity'], correctIndex: 1, explanation: 'Swan neck: PIP hyperextension + DIP flexion. Caused by intrinsic muscle tightness, volar plate laxity at PIP, and lateral band dorsal subluxation. Boutonnière deformity is the opposite: PIP flexion + DIP hyperextension (central slip rupture). Both result from chronic synovitis destroying periarticular structures.'),
    QuizQuestion(question: 'Methotrexate in RA is supplemented with folic acid to:', options: ['Increase its efficacy', 'Reduce side effects (stomatitis, GI upset, cytopenias) without reducing efficacy', 'Treat anemia of chronic disease', 'Improve joint lubrication'], correctIndex: 1, explanation: 'Folic acid (1 mg daily or 5 mg weekly, taken on non-MTX days) reduces methotrexate side effects: oral ulcers, nausea, hepatotoxicity, and cytopenias. It does NOT reduce MTX efficacy. Folinic acid (leucovorin) can be used for rescue if MTX toxicity is severe. Regular monitoring: CBC, LFTs, creatinine.'),
    QuizQuestion(question: 'Atlantoaxial (C1-C2) instability in RA is dangerous because:', options: ['It causes carpal tunnel syndrome', 'Pannus erosion of the transverse ligament allows C1 to sublux on C2, risking spinal cord compression', 'It only causes neck pain', 'It is always asymptomatic'], correctIndex: 1, explanation: 'RA-related C1-C2 instability: inflammatory pannus erodes the transverse ligament and dens → anterior atlantoaxial subluxation. ADI >3mm (adults) is abnormal. Can progress to myelopathy (cord compression) or sudden death. Flexion-extension cervical X-rays are essential before intubation/surgery in RA patients. Surgical fusion if symptomatic or ADI >9mm.'),
    QuizQuestion(question: 'Osteoarthritis (OA) differs from RA in that OA:', options: ['Is an autoimmune disease', 'Is a degenerative joint disease with asymmetric involvement, DIP/PIP nodes, and minimal morning stiffness (<30 min)', 'Always requires biological therapy', 'Causes positive RF and anti-CCP'], correctIndex: 1, explanation: 'OA: degenerative "wear and tear" of articular cartilage. Key differences from RA: asymmetric involvement, DIP joints involved (Heberden nodes), PIP nodes (Bouchard), minimal morning stiffness (<30 minutes vs. >1 hour in RA), normal inflammatory markers, and no systemic features. First CMC joint involvement is classic.'),
  ]),
  ...
  'Physical Modalities 1': const EpisodeQuiz(episodeTitle: 'Physical Modalities 1', questions: [
    QuizQuestion(question: 'Therapeutic ultrasound heats tissue through:', options: ['Conduction', 'Convection', 'Conversion (mechanical vibration → thermal energy)', 'Radiation'], correctIndex: 2, explanation: 'Ultrasound: acoustic energy (1-3 MHz) is absorbed by tissue and CONVERTED to heat (conversion heating). It is a deep heating modality reaching 3-5 cm. Frequency affects depth: 1 MHz = deeper (3-5 cm), 3 MHz = superficial (1-2 cm). Intensity: 1-2 W/cm². Heats collagen-rich tissues preferentially (tendon, ligament, scar tissue, joint capsule).'),
    QuizQuestion(question: 'Ultrasound is contraindicated over:', options: ['Normal muscle tissue', 'Growth plates (epiphyseal plates) in children, malignancies, and the pregnant uterus', 'Chronic tendinopathy', 'Post-surgical scar tissue'], correctIndex: 1, explanation: 'Ultrasound contraindications: growth plates (risk of premature closure), malignancy (could accelerate growth/metastasis), pregnant uterus, thrombophlebitis/DVT (risk of embolization), cemented joint prostheses (loosening), pacemakers, eyes, brain, spinal cord (after laminectomy), reproductive organs, and infected tissue.'),
    QuizQuestion(question: 'Superficial heating modalities include all EXCEPT:', options: ['Hot packs (hydrocollator)', 'Paraffin wax', 'Therapeutic ultrasound', 'Fluidotherapy'], correctIndex: 2, explanation: 'Superficial heating (penetrates to ~1-2 cm): hot packs, paraffin wax, fluidotherapy, warm whirlpool, infrared lamps. These heat skin and subcutaneous tissue only. Deep heating modalities (penetrate >3 cm): therapeutic ultrasound, shortwave diathermy, microwave diathermy. The distinction matters for treating deep vs. superficial pathology.'),
    QuizQuestion(question: 'Cryotherapy (cold) reduces pain through all EXCEPT:', options: ['Slowing nerve conduction velocity', 'Reducing muscle spindle activity', 'Causing vasodilation', 'Reducing metabolic rate and inflammation'], correctIndex: 2, explanation: 'Cryotherapy mechanisms: slows nerve conduction (pain signals), reduces muscle spindle firing (decreases spasticity), reduces metabolic rate (limits secondary injury), causes vasoconstriction (reduces edema/inflammation), and increases pain threshold. Initial vasoconstriction occurs; hunting response (Lewis reaction) is brief vasodilation after prolonged cold — NOT the primary therapeutic mechanism.'),
    QuizQuestion(question: 'TENS (transcutaneous electrical nerve stimulation) works primarily through:', options: ['Directly healing tissue', 'Gate control theory — large fiber stimulation inhibits small fiber pain transmission at the spinal cord', 'Muscle strengthening', 'Increasing blood pressure'], correctIndex: 1, explanation: 'TENS: applies electrical stimulation to large myelinated A-beta fibers, which inhibit pain transmission from small A-delta and C fibers at the dorsal horn (gate control theory, Melzack and Wall). Conventional/high-frequency TENS (50-100 Hz): gate control. Low-frequency/acupuncture-like TENS (2-4 Hz): endogenous endorphin release. Non-invasive, minimal side effects.'),
  ]),

  'Physical Modalities 2': const EpisodeQuiz(episodeTitle: 'Physical Modalities 2', questions: [
    QuizQuestion(question: 'Shortwave diathermy is contraindicated in patients with:', options: ['Chronic back pain', 'Metal implants, pacemakers, and over malignancies', 'Osteoarthritis', 'Mild muscle strain'], correctIndex: 1, explanation: 'Shortwave diathermy (SWD): deep heating using electromagnetic energy (27.12 MHz). Contraindicated with metal implants (focal overheating), pacemakers/electronic implants (interference), malignancy, pregnancy, active bleeding, DVT, sensory impairment, and over fluid-filled cavities. Metal concentrates the electromagnetic field, creating dangerous hot spots.'),
    QuizQuestion(question: 'Neuromuscular electrical stimulation (NMES) is used to:', options: ['Diagnose nerve injuries', 'Activate and strengthen weakened muscles through electrical stimulation of the motor nerve', 'Measure nerve conduction velocity', 'Reduce bone density'], correctIndex: 1, explanation: 'NMES: electrical current applied over a motor point causes muscle contraction. Uses: muscle re-education after surgery/injury, strengthening (quadriceps after ACL repair), reducing atrophy in immobilized limbs, functional electrical stimulation (FES) in SCI/stroke. Parameters: typically 35-50 Hz, on/off duty cycle, sufficient intensity for visible contraction.'),
    QuizQuestion(question: 'Iontophoresis delivers medication through the skin using:', options: ['Ultrasound waves', 'Direct electrical current that drives charged drug molecules into tissue', 'Magnetic fields', 'Infrared light'], correctIndex: 1, explanation: 'Iontophoresis: direct current drives charged medication ions through the skin. The medication is placed under the electrode with the SAME charge (like charges repel — driving the drug into tissue). Common medications: dexamethasone (anti-inflammatory, negative pole), lidocaine (anesthetic, positive pole), acetic acid (calcium deposits). Low-level current (1-4 mA).'),
    QuizQuestion(question: 'Phonophoresis differs from iontophoresis in that phonophoresis uses:', options: ['Electrical current', 'Ultrasound waves to drive topical medications through the skin', 'Laser light', 'Magnetic resonance'], correctIndex: 1, explanation: 'Phonophoresis: ultrasound energy enhances transdermal delivery of topical medications (typically hydrocortisone or diclofenac gel). The ultrasound coupling gel is mixed with or replaced by the medication. Less studied than iontophoresis, and not all medications transmit well through ultrasound. Contraindications are the same as therapeutic ultrasound.'),
    QuizQuestion(question: 'The hunting response (Lewis reaction) during cryotherapy refers to:', options: ['Permanent tissue damage', 'Cyclical vasodilation after 15-20 minutes of sustained cold application', 'Increased nerve conduction', 'Pain elimination'], correctIndex: 1, explanation: 'Hunting response (Lewis reaction): after prolonged cold application (15-20+ minutes), the body initiates brief periods of vasodilation (to protect tissue from frost injury) alternating with vasoconstriction. This is a protective mechanism. It does not negate the therapeutic benefit of cold. Application time should be 15-20 minutes to achieve therapeutic cooling without tissue injury.'),
  ]),

  'Physical Modalities 3': const EpisodeQuiz(episodeTitle: 'Physical Modalities 3', questions: [
    QuizQuestion(question: 'Low-level laser therapy (LLLT/photobiomodulation) is proposed to:', options: ['Burn tissue', 'Stimulate cellular processes (ATP production, collagen synthesis) without thermal effects', 'Replace surgical procedures', 'Diagnose cancer'], correctIndex: 1, explanation: 'LLLT/photobiomodulation: low-power laser or LED light stimulates cellular mitochondria (cytochrome c oxidase), increasing ATP production and promoting tissue repair. Non-thermal mechanism. Used for pain, inflammation, wound healing, and musculoskeletal conditions. Wavelengths: 600-1000 nm (red and near-infrared). Evidence is growing but mixed for many conditions.'),
    QuizQuestion(question: 'Contrast baths alternate between:', options: ['Hot and cold water immersion to create a vascular pumping effect', 'Different ultrasound frequencies', 'Deep and superficial heating', 'Electrical and manual stimulation'], correctIndex: 0, explanation: 'Contrast baths: alternating immersion in hot water (38-40°C) and cold water (10-18°C), typically 3-4 minutes hot then 1 minute cold, repeated 4-6 cycles. The alternating vasodilation and vasoconstriction creates a "pumping effect" that may reduce edema. Used for distal extremity conditions (hands, feet) with subacute swelling or CRPS.'),
    QuizQuestion(question: 'Continuous passive motion (CPM) machines are most commonly used after:', options: ['Spinal surgery', 'Total knee arthroplasty to maintain ROM and prevent adhesions', 'Hip fracture ORIF', 'Rotator cuff repair only'], correctIndex: 1, explanation: 'CPM: mechanically moves the joint through a preset ROM continuously. Most studied after total knee arthroplasty. Benefits: maintains ROM, prevents adhesions, promotes articular cartilage nutrition, reduces pain and swelling. Current evidence is mixed — many surgeons have moved away from routine CPM use, preferring aggressive early physical therapy instead.'),
    QuizQuestion(question: 'Electrical stimulation using interferential current (IFC) differs from TENS in that IFC:', options: ['Uses a lower frequency', 'Uses two medium-frequency currents that intersect in deep tissue to create a low-frequency therapeutic current', 'Is applied to the skin surface only', 'Cannot be used for pain'], correctIndex: 1, explanation: 'IFC: two medium-frequency currents (e.g., 4000 Hz and 4100 Hz) are applied through 4 electrodes. Where they intersect in tissue, they create a beat frequency (100 Hz in this example) at depth. The medium frequency penetrates tissue better than the low-frequency TENS signal. Advantage: deeper penetration, more comfortable, less skin resistance.'),
    QuizQuestion(question: 'Paraffin wax baths are most commonly used for:', options: ['Large body areas like the back', 'The hands and feet (arthritis, scleroderma, joint stiffness)', 'The lungs', 'Post-surgical wounds'], correctIndex: 1, explanation: 'Paraffin wax (mixture of paraffin + mineral oil at 52-54°C): superficial moist heat that conforms to irregular joint surfaces. Best for hands and feet. Methods: dip-wrap (most common — 7-12 dips then wrap), dip-immerse, paint method. Benefits in RA/OA: reduces pain and stiffness, improves ROM before exercise. Contraindicated over open wounds, impaired sensation, and peripheral vascular disease.'),
  ]),

  'Physical Modalities 4': const EpisodeQuiz(episodeTitle: 'Physical Modalities 4', questions: [
    QuizQuestion(question: 'Traction for cervical radiculopathy works by:', options: ['Strengthening neck muscles', 'Distracting vertebral segments, widening foramina, and reducing intradiscal pressure', 'Fusing the vertebrae', 'Increasing disc herniation'], correctIndex: 1, explanation: 'Cervical traction: distraction opens the intervertebral foramina (reducing nerve root compression), reduces intradiscal pressure, stretches paraspinal muscles, and may help retract disc material. Parameters: intermittent, 20-30 lbs, 15-20 minutes, neck in slight flexion (opens posterior foramina). Contraindicated: RA with C-spine instability, myelopathy, vertebral artery insufficiency.'),
    QuizQuestion(question: 'Extracorporeal shock wave therapy (ESWT) is FDA-approved for:', options: ['Spinal stenosis', 'Chronic plantar fasciitis and lateral epicondylitis refractory to conservative treatment', 'Acute muscle strains', 'Osteoporosis'], correctIndex: 1, explanation: 'ESWT: focused acoustic pressure waves create microtrauma at the tissue interface, stimulating neovascularization and healing. FDA-approved for chronic plantar fasciitis and chronic lateral epicondylitis failing 6+ months of conservative treatment. Also studied for calcific tendinitis, non-union fractures, and Achilles tendinopathy. Mechanism: stimulates biologic healing response.'),
    QuizQuestion(question: 'The cold spray and stretch technique is used to treat:', options: ['Fractures', 'Myofascial trigger points — spray desensitizes the area, allowing deeper stretching', 'Ligament tears', 'Bone spurs'], correctIndex: 1, explanation: 'Spray and stretch: vapocoolant spray (ethyl chloride or fluoromethane) applied in parallel sweeps over the trigger point and referred pain zone, creating superficial anesthesia. The muscle is simultaneously stretched to full length. The cold sensation activates large sensory fibers that "gate" pain, allowing the muscle to release the trigger point. Follow with moist heat.'),
    QuizQuestion(question: 'Whirlpool therapy is contraindicated in patients with:', options: ['Muscle soreness', 'Active bleeding, unstable blood pressure, or incontinence (for full-body immersion)', 'Mild joint stiffness', 'Subacute ankle sprain'], correctIndex: 1, explanation: 'Whirlpool contraindications: active hemorrhage/bleeding, unstable cardiovascular conditions, incontinence (infection risk in shared equipment), impaired sensation, severe peripheral vascular disease, and acute inflammation (warm water increases edema). Cold whirlpool may be appropriate for acute injuries. Water temperature: warm = 36-38°C, neutral = 33-35°C, cold = 10-18°C.'),
    QuizQuestion(question: 'Biofeedback uses:', options: ['Medications to control pain', 'Electronic monitoring to provide real-time information about physiological processes for self-regulation', 'Surgical implants', 'Manual therapy only'], correctIndex: 1, explanation: 'Biofeedback: electronic devices measure physiological signals (EMG, skin temperature, heart rate, EEG) and display them in real-time, allowing patients to learn voluntary control. Uses in rehab: muscle re-education (EMG biofeedback for quad activation post-surgery), pelvic floor training (incontinence), pain management, and relaxation training. Evidence-based for many applications.'),
  ]),

  // ── Osteoporosis 1-2 ──
  'Osteoporosis 1': const EpisodeQuiz(episodeTitle: 'Osteoporosis 1', questions: [
    QuizQuestion(question: 'Osteoporosis is defined by a DEXA T-score of:', options: ['>-1.0', '-1.0 to -2.5', '≤-2.5', '<-3.5 only'], correctIndex: 2, explanation: 'WHO criteria: T-score ≥-1.0 = normal. T-score -1.0 to -2.5 = osteopenia. T-score ≤-2.5 = osteoporosis. T-score ≤-2.5 with fragility fracture = severe osteoporosis. T-score compares to young adult peak bone mass. Z-score (age-matched) is used in premenopausal women and men <50.'),
    QuizQuestion(question: 'The most common sites for osteoporotic fractures are:', options: ['Skull and ribs', 'Vertebral body, hip (proximal femur), and distal radius (Colles fracture)', 'Tibial shaft and fibula', 'Hands and feet'], correctIndex: 1, explanation: 'Osteoporotic fracture sites: vertebral compression fractures (most common overall, often asymptomatic), hip fractures (proximal femur — highest morbidity and mortality, 20-30% 1-year mortality), and distal radius (Colles fracture from FOOSH). These are trabecular bone-rich areas that lose density earliest.'),
    QuizQuestion(question: 'Weight-bearing exercise helps prevent osteoporosis because:', options: ['It increases calcium absorption', 'Mechanical loading stimulates osteoblast activity and bone formation (Wolff\'s law)', 'It replaces medication therapy', 'It only works in young people'], correctIndex: 1, explanation: 'Wolff\'s law: bone adapts to the loads placed upon it. Weight-bearing and resistance exercises create mechanical loading that stimulates osteoblast activity and new bone formation. Best exercises: walking, jogging, stair climbing, resistance training. Swimming/cycling are non-weight-bearing and less effective for bone density. Exercise also improves balance and reduces fall risk.'),
    QuizQuestion(question: 'Bisphosphonates (alendronate, risedronate) work by:', options: ['Stimulating osteoblasts', 'Inhibiting osteoclast-mediated bone resorption', 'Increasing calcium absorption', 'Replacing estrogen'], correctIndex: 1, explanation: 'Bisphosphonates: bind to hydroxyapatite at bone resorption sites and are taken up by osteoclasts, inhibiting their activity and inducing apoptosis. This reduces bone resorption and net bone loss. First-line treatment for osteoporosis. Must be taken with water on empty stomach, upright for 30 minutes (prevent esophageal ulceration). Rare risks: osteonecrosis of jaw, atypical femoral fractures.'),
    QuizQuestion(question: 'FRAX score is used to:', options: ['Diagnose osteoporosis on DEXA', 'Calculate 10-year probability of major osteoporotic fracture and hip fracture to guide treatment decisions', 'Measure bone formation markers', 'Determine calcium intake needs'], correctIndex: 1, explanation: 'FRAX: online tool integrating clinical risk factors (age, sex, BMI, prior fracture, family history, smoking, alcohol, steroids, RA, secondary causes) ± femoral neck BMD to calculate 10-year fracture probability. Treatment threshold: ≥20% major osteoporotic fracture OR ≥3% hip fracture. Used for osteopenic patients to decide if pharmacotherapy is warranted.'),
  ]),

  'Osteoporosis 2': const EpisodeQuiz(episodeTitle: 'Osteoporosis 2', questions: [
    QuizQuestion(question: 'Denosumab (Prolia) treats osteoporosis by:', options: ['Inhibiting osteoblasts', 'Blocking RANKL, thereby inhibiting osteoclast formation and bone resorption', 'Increasing intestinal calcium absorption', 'Stimulating vitamin D production'], correctIndex: 1, explanation: 'Denosumab: monoclonal antibody against RANKL (receptor activator of nuclear factor kappa-B ligand). RANKL is essential for osteoclast differentiation and activation. By blocking RANKL, denosumab prevents osteoclast formation → reduced bone resorption. Given as subcutaneous injection every 6 months. Unlike bisphosphonates, it does not accumulate in bone and is safe in renal impairment.'),
    QuizQuestion(question: 'Teriparatide (Forteo) is unique among osteoporosis treatments because:', options: ['It inhibits bone resorption like bisphosphonates', 'It is an anabolic agent (recombinant PTH) that stimulates new bone formation', 'It is a calcium supplement', 'It replaces vitamin D'], correctIndex: 1, explanation: 'Teriparatide: recombinant PTH(1-34) — the only anabolic (bone-building) agent. Intermittent PTH administration paradoxically stimulates osteoblasts more than osteoclasts, increasing bone formation. Used for severe osteoporosis, multiple fractures, or failure of antiresorptive therapy. Limited to 2 years. Must follow with an antiresorptive (bisphosphonate) to maintain gains.'),
    QuizQuestion(question: 'Recommended daily calcium intake for osteoporosis prevention in postmenopausal women is:', options: ['500 mg', '800 mg', '1200 mg', '2000 mg'], correctIndex: 2, explanation: 'Recommended calcium: 1200 mg/day for women >50 and men >70. 1000 mg/day for younger adults. Diet first (dairy, leafy greens, fortified foods); supplement the deficit. Calcium carbonate (40% elemental Ca, take with food) or calcium citrate (21% elemental, better absorbed on empty stomach). Excessive supplementation (>2000 mg/day) increases kidney stone risk.'),
    QuizQuestion(question: 'Vitamin D is essential for bone health because:', options: ['It directly strengthens collagen', 'It enhances intestinal calcium absorption and is necessary for bone mineralization', 'It inhibits PTH secretion only', 'It is a direct osteoblast stimulant'], correctIndex: 1, explanation: 'Vitamin D: promotes intestinal calcium absorption (only 10-15% absorbed without vitamin D vs. 30-40% with adequate levels). Also needed for proper bone mineralization. Target 25-OH vitamin D: ≥30 ng/mL. Recommended intake: 800-1000 IU/day (higher for deficiency). Vitamin D deficiency → osteomalacia (defective mineralization) and secondary hyperparathyroidism → increased bone resorption.'),
    QuizQuestion(question: 'Fall prevention is critical in osteoporosis management because:', options: ['Falls are rare in elderly patients', 'Most osteoporotic fractures result from falls, so preventing falls prevents fractures', 'Medications alone are sufficient', 'Exercise increases fall risk'], correctIndex: 1, explanation: 'Over 90% of hip fractures result from falls. Fall prevention strategies: balance/strength training (tai chi has strong evidence), home safety modifications (remove rugs, improve lighting, add grab bars), medication review (reduce sedatives, antihypertensives that cause orthostasis), vision correction, and assistive devices. Combined with pharmacotherapy, this is the most effective fracture prevention approach.'),
  ]),
