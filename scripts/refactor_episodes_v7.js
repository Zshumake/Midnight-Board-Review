...
function getNewCategory(title) {
    ...
    // 2. Miscellaneous (Now includes Burns)
    if (t.includes('bioethics') || t.includes('biostatistics') || t.includes('board exam') ||
        t.includes('osteoporosis') || t.includes('burns')) {
...
const catOrder = [
    ...
    "Rheumatology",
    "Physical Modalities",
    "Miscellaneous" // Burns is here now
];
...
console.log('Updated js/episodes.js with v7 categories (Burns in Misc)');
